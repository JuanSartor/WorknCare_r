...
$("#listGrupos").jqGrid({
    ...
    viewrecords: true,
    sortorder: "asc",
    caption: "Grupos de programas de salud empresa",
    ...
    gridComplete: function () {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('programa_salud_grupo_empresa','programa_salud_grupo_empresa_form','id=" + id + "','Main',this)\"><button>Editar</button></a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function () {
    ...
    x_deleteMultiple({
        ...
        submodulo: 'deletemultiple_programa_salud_grupo_empresa'
    });
});


$("#btnNew").click(function () {
    x_goTo('programa_salud_grupo_empresa', 'programa_salud_grupo_empresa_form', '', 'Main', this);
});


$("#modulo").val("programa_salud_grupo_empresa");
$("#submodulo").val("programa_salud_grupo_empresa_list");
