...
$("#submodulo").val("titulo_profesional_list");
x_runJS();
...
$("#list").jqGrid({
    ...
    colModel: [
        ...
        {name: 'titulo_profesional', index: 'titulo_profesional', width: 150, sortable: false}
        
    ],
    
    rowNum: 50,
    pager: '#pager',
    sortname: 'titulo_profesional',
    viewrecords: true,
    sortorder: "asc",
    ...
    gridComplete: function() {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','titulo_profesional_form','id=" + id + "','Main',this)\">Editar</a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function() {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja el título profesional?',
        submodulo: 'deletemultiple_titulo_profesional'
    });
...
$("#btnNew").click(function() {
    x_goTo('maestros_genericos', 'titulo_profesional_form', '', 'Main', this);
});
