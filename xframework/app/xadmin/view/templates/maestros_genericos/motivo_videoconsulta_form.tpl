...
<div id="colRight">
    ...
    <div class="block">
        ...
        <div class="title_bar">
            <div class="text">MOTIVO VIDEO CONSULTA &raquo; {if $record} EDITAR {else} NUEVA{/if}</div>
                        ...
                        <div id="listado_programas_categorias" {if $listado_programas_categorias}style="display:block;"{else}style="display:none"{/if}>
                            ...
                            <ul>
                                {foreach from=$listado_programas_categorias item=programa_categoria}
                                    <li data-id="{$programa_categoria.idmotivovideoconsulta_programa_categoria}" data-programa_categoria="{$programa_categoria.idprograma_categoria}" class="programa_categoria"><span class="delete_programa_categoria" data-id="{$programa_categoria.idmotivovideoconsulta_programa_categoria}" title="Eliminar"> X </span> {$programa_categoria.programa_salud} - {$programa_categoria.programa_categoria} </li>
                                    {/foreach}
                            </ul>
                        </div>
