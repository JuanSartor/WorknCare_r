...
$("#listado_programas_categorias").on("click", ".delete_programa_categoria", function () {
    ...
    var url = "xadmin.php?";
    var queryStr = "action=1&modulo=maestros_genericos&submodulo=motivovisita_programa_categoria_delete&id=" + id;
...
$("#agregar_programa_categoria").click(function () {
    ...
    var url = "xadmin.php?";
    var queryStr = "action=1&modulo=maestros_genericos&submodulo=motivovisita_programa_categoria_add&idprograma_categoria=" + $("#idprograma_categoria").val() + "&motivoVisita_idmotivoVisita=" + $("#idmotivoVisita").val();
