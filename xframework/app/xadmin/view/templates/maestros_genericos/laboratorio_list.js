...
$("#submodulo").val("laboratorio_list");
x_runJS();
...
$("#list").jqGrid({
    ...
    gridComplete: function() {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','laboratorio_form','id=" + id + "','Main',this)\">Editar</a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function() {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja el Laboratorio?',
        submodulo: 'deletemultiple_laboratorio'
    });
...
$("#btnNew").click(function() {
    x_goTo('maestros_genericos', 'laboratorio_form', '', 'Main', this);
});
