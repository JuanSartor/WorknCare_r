...
$("#submodulo").val("motivo_consultaexpress_list");
x_runJS();
...
$("#list").jqGrid({
    ...
    colModel: [
        ...
        {name: 'motivoConsultaExpress', index: 'motivoConsultaExpress', width: 350, sortable: false}

    ],

    rowNum: 50,
    pager: '#pager',
    sortname: 'motivoConsultaExpress',
    viewrecords: true,
    sortorder: "asc",
    caption: "Motivo Consulta Express",
    ...
    gridComplete: function () {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','motivo_consultaexpress_form','id=" + id + "','Main',this)\"><button>Editar</button></a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function () {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja el Motivo de Consulta Express?',
        submodulo: 'deletemultiple_motivo_consultaexpress'
    });
...
$("#btnNew").click(function () {
    x_goTo('maestros_genericos', 'motivo_consultaexpress_form', '', 'Main', this);
});
