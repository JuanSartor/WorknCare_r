...
$("#submodulo").val("servicios_medicos_list");
x_runJS();
...
$("#list").jqGrid({
    ...
    colModel: [
        ...
        {name: 'servicio_medico', index: 'servicio_medico', width: 150, sortable: false}
        
    ],
    
    rowNum: 50,
    pager: '#pager',
    sortname: 'servicio_medico',
    viewrecords: true,
    sortorder: "asc",
    caption: "Servicios Médicos",
    ...
    gridComplete: function() {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','servicios_medicos_form','id=" + id + "','Main',this)\">Editar</a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function() {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja el servicio médico?',
        submodulo: 'deletemultiple_servicios_medicos'
    });
...
$("#btnNew").click(function() {
    x_goTo('maestros_genericos', 'servicios_medicos_form', '', 'Main', this);
});
