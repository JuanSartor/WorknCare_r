...
$("#submodulo").val("motivo_videoconsulta_list");
x_runJS();
...
$("#list").jqGrid({
    ...
    colModel: [
        ...
        {name: 'motivoVideoConsulta', index: 'motivoVideoConsulta', width: 150, sortable: false}

    ],

    rowNum: 50,
    pager: '#pager',
    sortname: 'motivoVideoConsulta',
    viewrecords: true,
    sortorder: "asc",
    ...
    gridComplete: function () {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','motivo_videoconsulta_form','id=" + id + "','Main',this)\"><button>Editar</button></a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function () {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja el Motivo de Video Consulta?',
        submodulo: 'deletemultiple_motivo_videoconsulta'
    });
...
$("#btnNew").click(function () {
    x_goTo('maestros_genericos', 'motivo_videoconsulta_form', '', 'Main', this);
});
