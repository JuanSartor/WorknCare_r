...
$("#btnGuardar").click(function () {
    ...
    x_sendForm($('#f_record'), true, doAddFromWindow, {'modulo': 'maestros_genericos', 'submodulo': 'motivo_videoconsulta_list'});

});

$("#back").click(function () {
    x_goTo('maestros_genericos', 'motivo_videoconsulta_list', '', 'Main', this);
});
...
$("#agregar_especialidad").click(function () {
    ...
    var url = "xadmin.php?";
    var queryStr = "action=1&modulo=maestros_genericos&submodulo=motivovideoconsulta_especialidad_add&especialidad_idespecialidad=" + $("#especialidad_idespecialidad").val() + "&motivoVideoConsulta_idmotivoVideoConsulta=" + $("#idmotivoVideoConsulta").val();
...
$("#listado_especialidades").on("click", ".delete_especialidad", function () {
    ...
    var url = "xadmin.php?";
    var queryStr = "action=1&modulo=maestros_genericos&submodulo=motivovideoconsulta_especialidad_delete&id=" + id;
...
$("#listado_programas_categorias").on("click", ".delete_programa_categoria", function () {
    ...
    var url = "xadmin.php?";
    var queryStr = "action=1&modulo=maestros_genericos&submodulo=motivovideoconsulta_programa_categoria_delete&id=" + id;
...
$("#agregar_programa_categoria").click(function () {
    ...
    var url = "xadmin.php?";
    var queryStr = "action=1&modulo=maestros_genericos&submodulo=motivovideoconsulta_programa_categoria_add&idprograma_categoria=" + $("#idprograma_categoria").val() + "&motivoVideoConsulta_idmotivoVideoConsulta=" + $("#idmotivoVideoConsulta").val();
