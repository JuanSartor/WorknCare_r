                    ...
                    <tr>
                        <td style="padding:0 16px">
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                Nous avons bien reçu votre paiement, vous pouvez maintenant vous connecter à votre compte pour créer vos Pass.
                            </p>
                    ...
                    <tr>
                        <td style="padding:16px">
                            <p style="color:#415B70; font-size:14px; font-family:'Helvetica', Arial, sans-serif">
                                <a href="{$url}creer-compte.html?connecter" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">Se connecter</a>
                            </p>
