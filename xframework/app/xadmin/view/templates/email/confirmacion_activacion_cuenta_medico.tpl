        ...
        <tr>
            <td bgcolor="#F7F7F7" style="padding: 24px 0">
                ...
                <table width="600" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="12" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td>
                            <p style="color:#415B70; font-size:17px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold">Felicitations  <span style="color:#31A592; font-size:18px">{$usuario.dr}  {$usuario.nombre} {$usuario.apellido}</span></p>
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                Le service administratif de DoctorPlus a vérifié votre compte et l'a validé, {$usuario.email}
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="{$url}medecin-ou-professionnel/?connecter" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px; font-family:'Helvetica', Arial, sans-serif">Me connecter</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <p style="color:#31A592; font-size:18px; font-family:'Helvetica', Arial, sans-serif">
                                Créez votre cabinet virtuel pour pouvoir démarrer votre activité de téléconsultation sur DoctorPlus
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <p style="color:#999999; font-size:12px; font-family:'Helvetica', Arial, sans-serif; text-align:left; line-height:14px">
                                ...
                                Si {$usuario.email} ne correspond pas à votre compte sur DoctorPlus, envoyez-nous s’il vous plait un email à <a style="text-decoration:none; line-height:14px; color:#415B70; font-weight:bold" class="rsp-lnk" href="mailto:support@workncare.io">support@workncare.io</a> pour déconnecter votre adresse email de ce compte. 
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <table width="600" align="center" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td align="center">
                            <p style="color:#999999; font-size:12px; font-family:'Helvetica', Arial, sans-serif; text-align:center">&copy; {$smarty.now|date_format:"%Y"} DoctorPlus, Tous droits réservés.</p>
                        </td>
                    </tr>
                </table>
            </td>
