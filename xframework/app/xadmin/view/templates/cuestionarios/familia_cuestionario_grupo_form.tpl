...
<div id="colRight">
    ...
    <div class="block">
        ...
        <div class="title_bar">
            <div class="text">Familia de Cuestionarios &raquo; {if $record} Editar Familia de Cuestionarios {else} Nueva Familia de Cuestionarios{/if}</div>

            {x_form_html_button id="btnGuardar" label="Guardar" w="100" type="button" class="icon save"}
            &nbsp;
            {x_form_html_button id="new" label="Volver" function_name="x_goTo" w="100" type="button" p1="'cuestionarios'" p2="'familia_cuestionario_grupo_list'" p3="''" p4="'Main'" p5="this" class="icon arrowleft"}
            &nbsp;
        ...
        <div class="contenido">
            ...
            <div class="xForm ">
                <form action="{$controller}.php?action=1&modulo=cuestionarios&submodulo=familia_cuestionario_grupo_form" method="post" name="f_record" id="f_record">
                    <input type="hidden" name="id_familia_cuestionarios" id="id_familia_cuestionarios" value="{$record.id_familia_cuestionarios}" />
