<div id="colRight">	
    ...
    <div class="block">
        ...
        <div class="title_bar"><span class="text">	Programas de Salud&raquo; </span>
        ...
        <div class="contenido">
            ...
            <form action="{$controller}.php?action=1&modulo=programa_salud&submodulo=programas_list_export"  target="_blank" method="post" id="f_export" >           
                ...
                <form action="{$controller}.php?action=1&modulo=programa_salud&submodulo=programa_salud_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >


                    <div class="form_container">
                        <div class="title">
                            Consulta de Programas de Salud 
                        </div>
                        ...
                        <ul>
                            ...
                            <li class="left">
                                <label>Nombre </label> 
                                {x_form_input  id="programa_salud" descriptor="none" isRequired="false" maxChars=45 class="" value=$paginate.request.programa_salud} 
                            </li>   
