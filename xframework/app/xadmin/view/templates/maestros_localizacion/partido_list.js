...
$("#list").jqGrid({ 
    ...
    datatype: "json", 
    colNames:[' ','Partido','Provincia','Pa&iacute;s'], 
    colModel:[  
                {name:'act',index:'act', width:25,sortable:false},
				{name:'partido',index:'par.partido', width:200},
				{name:'provincia',index:'pro.provincia', width:200},
                {name:'pais',index:'pa.pais', width:200}
              ], 
    rowNum:25, 
    /*rowList:[10,20,30],*/ 
    pager: '#pager', 
    sortname: 'par.partido', 
    viewrecords: true, 
    sortorder: "asc, pro.provincia asc, par.partido asc", 
    caption:"Partidos" ,
	...
	gridComplete: function(){ 
        ...
        for(var i=0;i < ids.length;i++){ 
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_localizacion','partido_form','id="+id+"','Main',this)\"><img src=\"xframework/app/themes/admin/imgs/action_ico_edit.png\" /></a>"; 
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function(){
	...
	x_deleteMultiple({ ids:$("#list").jqGrid('getGridParam','selarrrow'),
					   callback:reload,
					   pregunta:'Desea dar de baja el/los partido/s?',
					   submodulo:'deletemultiple_partido'
					 });
...
$("#pais_idpais").change(function(){
	updateComboBox(this, 'provincia_idprovincia','ManagerProvincia', 'getComboProvinciasDePais',1);	
