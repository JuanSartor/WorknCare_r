<div id="colRight">	
    ...
    <div class="block">
        ...
        <div class="title_bar"><span class="text">	Textos Auxiliares&raquo; </span>
        ...
        <div class="contenido">
            ...
            <div class="xForm">
                <form action="{$controller}.php?action=1&modulo=texto_auxiliares&submodulo=texto_auxiliares_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >


                    <div class="form_container">
                        <div class="title">
                            Consulta de Familia de Capsulas 
                        </div>
                        ...
                        <ul>
                            ...
                            <li class="left">
                                ...
                                {x_form_input  id="texto_fr" descriptor="none" isRequired="false" maxChars=45 class="" value=$paginate.request.nombre} 
                            </li>   
