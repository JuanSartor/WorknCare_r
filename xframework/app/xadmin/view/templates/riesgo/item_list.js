...
$("#list").jqGrid({
    ...
    gridComplete: function () {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('riesgo','item_form','id=" + id + "','Main',this)\"><button>Editar</button></a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function () {
    ...
    x_deleteMultiple({
        ...
        callback: reload,
        pregunta: 'Desea eliminar el item riesgo y sus respectivos check?',
        submodulo: 'deletemultiple_item_riesgo'
    });
...
$("#btnNew").click(function () {
    x_goTo('riesgo', 'item_form', '', 'Main', this);
});


$("#modulo").val("riesgo");
$("#submodulo").val("item_list");
