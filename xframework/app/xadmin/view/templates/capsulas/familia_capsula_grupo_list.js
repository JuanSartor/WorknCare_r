...
$("#listFamilias").jqGrid({
    ...
    gridComplete: function () {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('capsulas','familia_capsula_grupo_form','id=" + id + "','Main',this)\"><button>Editar</button></a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function () {
    ...
    x_deleteMultiple({
        ...
        callback: reload,
        pregunta: 'Desea eliminar las familias seleccionadas, eliminara los contenedores y capsulas asociadas?',
        submodulo: 'deletemultiple_familia_capsula_grupo'
    });
...
$("#btnNew").click(function () {
    x_goTo('capsulas', 'familia_capsula_grupo_form', '', 'Main', this);
});


$("#modulo").val("capsulas");
$("#submodulo").val("familia_capsula_grupo_list");
