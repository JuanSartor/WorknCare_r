<div id="colRight">	
    ...
    <div class="block">
        ...
        <div class="title_bar"><span class="text">	Capsulas&raquo; </span>
        ...
        <div class="contenido">
            ...
            <div class="xForm">
                ...
                <form action="{$controller}.php?action=1&modulo=capsulas&submodulo=capsula_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >

                    <div class="form_container">
                        <div class="title">
                            Consulta de Capsulas
                        </div>
