$(function () {
    ...
    $("a.select-consultorio").on("click", (function () {
        ...
        $("#agenda_semanal_medico").spin("large");
        x_loadModule('agenda', 'agenda_semanal', 'fecha=' + fecha + '&idconsultorio=' + $(this).data("id"), 'agenda_semanal_medico');
    }));
...
//tooltip en modal de turnos
    ...
    $("#a_get_dia_previous_week").click(function () {
        $("#Main").spin("large");
        var fecha = $("#dia_agenda").val();

        x_loadModule('agenda', 'agenda_semanal', 'previous=1&fecha=' + fecha + '&idconsultorio=' + $("#idconsultorio").val(), 'agenda_semanal_medico');
    });
//ir a la proxima semana
    $("#a_get_dia_next_week").click(function () {
        $("#Main").spin("large");
        var fecha = $("#dia_agenda").val();

        x_loadModule('agenda', 'agenda_semanal', 'next=1&fecha=' + fecha + '&idconsultorio=' + $("#idconsultorio").val(), 'agenda_semanal_medico');
    });
                    ...
                    x_doAjaxCall(
                            ...
                            function (data) {
                                ...
                                if (data.result) {
                                    ...
                                    $('#Main').spin("large");
                                    x_loadModule('agenda', 'agenda_semanal', 'fecha=' + fecha + '&idconsultorio=' + $("#idconsultorio").val(), 'agenda_semanal_medico').then(function () {
                                        $('#Main').spin(false);
                                    });
    ...
    // boton para cancelar disponibilidad, este btn tiene el icono del basurero
                ...
                x_doAjaxCall(
                        ...
                        function (data) {
                            ...
                            if (data.result) {
                                ...
                                x_loadModule('agenda', 'agenda_semanal', 'fecha=' + $("#dia_agenda").val() + '&idconsultorio=' + $("#idconsultorio").val(), 'agenda_semanal_medico').then(function () {
                                    $("body").spin(false);
                                });
