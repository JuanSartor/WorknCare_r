<div id="div_videoconsulta_red" class="cs-nc-section-holder">
    ...
    <div class="cs-nc-section-holder">
        <div class="container">
            <ol class="breadcrum">
                ...
                <li><a href="{$url}panel-medico/videoconsulta/">{"Video Consulta"|x_translate}</a></li>
                    {*<li class="active">{"Publicadas en la Red"|x_translate}</li>*}
        ...
        <section class="container ceprr-header">
            <div class="cs-nc-p2-header">
                ...
                <h2>{"Publicadas en la red"|x_translate}</h2>
                ...
                <li><a href="{$url}panel-medico/videoconsulta/red.html" class="ceprr-especialidad-trigger {if $smarty.request.from_filtro!="1"}active{/if}"><i class="fui-list-numbered"></i><span>{"Mi especialidad"|x_translate}</span></a></li>
                </ul>
                </div>
                *}
            </div>
        ...
        {*
        <div id="div_videoconsulta_red_contador" class="relative">
        <!--aqui cargamos el contador con las cantidades de las videoconsultas en la red-->
        ...
        *}
        ...
        <div class="ceprr-accordion-section-holder"  style="display: block;">	
            ...
            <a href="{$url}panel-medico/videoconsulta/red.html" class="ceprr-tags-back"><i class="icon-doctorplus-left-arrow"></i></a>
            ...
            {math assign="position" equation='ancho*((j/10)-5)' ancho=0.6849 j=$preferencia.valorPinesVideoConsulta} 
            <div class="cs-ui-range-values-promedio" style="left:{$position}%; top:-17px;">

            <div class="cs-ui-range-values-promedio-box">
            <span>{"Su tarifa"|x_translate}: &euro;{$preferencia.valorPinesVideoConsulta} </span>
            ...
            *}
            ...
            <!-- Cargamos el listado -->
            <div id="div_videoconsulta_red_listado" class="relative">
    ...
    <script>
        var PRECIO_MINIMO_VC = {$PRECIO_MINIMO_VC};
        var PRECIO_MAXIMO_VC = {$PRECIO_MAXIMO_VC};
    ...
    {literal}
        <script>
            ...
            $(function () {
                $("body").spin();
                x_loadModule('videoconsulta', 'videoconsulta_red_listado', 'do_reset=1&{$query_string}', 'div_videoconsulta_red_listado', BASE_PATH + "medico").then(function () {
                    $("body").spin(false);
                });
                ...
                $("#slider-range").slider({
                    range: true,
                    min: PRECIO_MINIMO_VC,
                    max: PRECIO_MAXIMO_VC,
                    step: 5,
        {/literal}
                    values: [{if $smarty.request.rango_minimo!=""}{$smarty.request.rango_minimo}{else}{$PRECIO_MINIMO_VC}{/if}, {if $smarty.request.rango_maximo!=""}{$smarty.request.rango_maximo}{else}{$PRECIO_MAXIMO_VC}{/if}],
        {literal}
                ...
                $("#btnAplicarFiltro").click(function () {
                    ...
                    window.location.href = BASE_PATH + "panel-medico/videoconsulta/red.html?from_filtro=1&" + $("#f_busqueda_red").serialize();
    ...
    {if $smarty.request.from_filtro=="1"}
        <script>
            ...
            {/foreach}
                                    ...
                                    if ({$smarty.request.rango_minimo} != PRECIO_MINIMO_VC || {$smarty.request.rango_maximo} != PRECIO_MAXIMO_VC){ldelim}
            ...
            {literal}
                    ...
                    tags_filtro.on('itemRemoved', function (event) {
                        ...
                        if (event.item.id = "filtro-rango") {
                            $("#rango_maximo").val(PRECIO_MAXIMO_VC);
                            $("#rango_minimo").val(PRECIO_MINIMO_VC);
                        }
