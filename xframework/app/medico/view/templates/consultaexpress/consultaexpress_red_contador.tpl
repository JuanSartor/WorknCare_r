<section class="container ceprr-todas">
    <ul>
        ...
        <li>
            <a href="{$url}panel-medico/consultaexpress/red.html?idespecialidad[]={$especialidad_consulta.idespecialidad}">
        ...
        <li>
            <a href="javascript:;" class="ceprr-ver-mas">
                {"Ver más especialidades"|x_translate}
            </a>
        </li>
        {else}
        <li style="display:none">
            <a href="{$url}panel-medico/consultaexpress/red.html?idespecialidad[]={$especialidad_consulta.idespecialidad}">
                <figure>  {$especialidad_consulta.cantidad}</figure>
                {$especialidad_consulta.especialidad}
            </a>
        </li>
        ...
        <div class="sin-registros">
            ...
            <p>{"No existen Consultas Express publicadas para Profesionales en la Red."|x_translate}</p>
        </div>
        {/if}
...
<script>
    $(function () {
        ...
        $("#div_consultaexpress_red_contador").spin(false);
