...
{$url_js_libs}/jquery-1.11.1.min.js;
...
{$url_js_libs}/jquery/masonry.pkgd.min.js;
{$url_js_libs}/jquery/jquery.dlmenu.js;
{$url_js_libs}/jquery/jquery.blockUI.js;
{$url_js_libs}/ion.rangeSlider-2.0.6/js/ion-rangeSlider/ion.rangeSlider.min.js;
...
{$url_js_libs}/slick/slick.js;
{$url_js_libs}/jquery/cropper-master/dist/cropper.js;
{$url_js_libs}/scrollbars/jquery.mCustomScrollbar.concat.min.js;
{$url_js_libs}/countid/countid.js;
{$url_js_libs}/audio/gumadapter.js;
{$url_js_libs}/Strength.js-master/src/strength.js;
{$url_js_libs}/tooltipster/tooltipster.bundle.min.js;
{$url_js_libs}/pickmeup/pickmeup.js;
{$url_js_libs}/velocity/velocity.min.js;
{*{$url_js_libs}/whatsapp/floating-wpp.min.js;*}
{*$url_js_core}/translate/translations.js;*}
{$url_js_libs}/jquery-browser-plugin-master/dist/jquery.browser.min.js
