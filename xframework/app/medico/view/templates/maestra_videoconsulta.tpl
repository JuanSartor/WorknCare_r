...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            var account ={ldelim}"idusuarioweb":{$account.id}, "idmedico":{$account.medico.idmedico}{rdelim};
        ...
        <link rel="stylesheet" type="text/css" href="{$url}xframework/app/medico/view/css/consultorio-virtual.css?v={$smarty.now|date_format:"%j"}" />
