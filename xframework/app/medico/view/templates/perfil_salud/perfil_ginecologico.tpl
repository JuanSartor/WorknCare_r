        ...
        <div class="col-md-12">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li><a  class="nombre_paciente" href="{$url}mis-pacientes/{$paciente.idpaciente}-{$paciente.nombre|str2seo}-{$paciente.apellido|str2seo}/">{$paciente.nombre} {$paciente.apellido}</a></li>
...
<section class="antecedentes-ginecologicos container">
    <div class="antecedentes-ginecologicos-holder">
        <form id="antecedentes_ginecologicos_form1" action="{$url}save_perfil_ginecologico_m.do" method="post" onsubmit="return false;">
...
<section class="antecedentes-ginecologicos container">
    <div class="row">
        <div class="antecedentes-ginecologicos-holder controles-holder">
            <form id="antecedentes_ginecologicos_form2" action="{$url}save_perfil_ginecologico_m.do" method="post"  onsubmit="return false;">
                <input type="hidden" name="idperfilSaludGinecologico" class="paciente_idpaciente" value="{$record.idperfilSaludGinecologico}"/>
                <input type="hidden" name="paciente_idpaciente"  value="{$paciente.idpaciente}"/>
...
<section class="antecedentes-ginecologicos container">
<div class="antecedentes-ginecologicos-holder">
            <form id="antecedentes_ginecologicos_form3" action="{$url}save_perfil_ginecologico_m.do" method="post"  onsubmit="return false;">
                <input type="hidden" name="idperfilSaludGinecologico" class="paciente_idpaciente" value="{$record.idperfilSaludGinecologico}"/>
               ...
               <div class="row input-row">
				...
				<div class="col-sm-6 col-sm-offset-2">						
					<div class="row">
						<div class="col-sm-12 col-md-3">
							<label class="right">{"FUM"|x_translate}</label>
						</div>
				...
				<div class="col-sm-2 col-xs-6">
                                <input type="number" id="cesareas" name="cesareas"  class="input-small" placeholder="" value="{$record.cesareas}">				</div>
				<div class="clearfix visible-xs"></div>
				<div class="col-sm-2 col-xs-6">
