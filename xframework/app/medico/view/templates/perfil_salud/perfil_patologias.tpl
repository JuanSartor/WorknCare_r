        ...
        <div class="col-md-12">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active">{"Enfermedades y patologías"|x_translate}</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="data-form health-profile">
    <div class="container">
        <form class="form patient-file relative" role="form" id="antecedentes_form_1" action="{$url}save_antecedentes_personales_m.do" method="post" onsubmit="return false;">
...
<section class="data-form health-profile">
    <div class="container">
        <form class="form patient-file relative" id="antecedentes_form_2" action="{$url}save_enfermedades_actuales_m.do" role="form" method="post" onsubmit="return false;">
                            ...
                            <div class="tagsinput-primary ceprr-tags">
                                ...
                                <script>
                                    var func_delete = function(event) {
                                        ...
                                        x_doAjaxCall(
                                                'POST',
                                                BASE_PATH + 'delete_enfermedades_actuales_m.do',
                                                'id=' + id,
                                                function(data) {
...
<section class="data-form health-profile">
    <div class="container">
        <form class="form patient-file relative" id="antecedentes_form_3" action="{$url}save_patologias_actuales_m.do" role="form" method="post" onsubmit="return false;">
            ...
            <div class="col-md-11 col-center pps-col">
                ...
                <button id="btn_save_antecedentes3" class="submit">{"grabar datos"|x_translate}</button>
            </div>
        </form>
    </div>
</section>	
