        ...
        <div class="bottom-data">
            ...
            <div class="modal-edit-data hidden">
                <div class="edit-data patient w">
                    ...
                    <form class="edit patient-data" id="colesterol_form" action="{$url}save_colesterol_form_m.do" method="post" onsubmit="return false;">
                ...
                x_sendForm($('#colesterol_form'), true, function(data) {
                    ...
                    if (data.result) {
                        if ($("#idperfilSaludBiometricos").val() != "") {
                            ...
                            x_loadModule('perfil_salud', 'modulo_colesterol', 'idpaciente=' + $("#paciente_idpaciente").val(), "div_colesterol", BASE_PATH + "medico");
                        } else {
