<div class="form-content edit-data">
    ...
    <form id="vacuna_form" action="{$url}medico_vacuna_form_paciente.do" method="post"  onsubmit="return false;">
        ...
        <p class="text-center">
            ...
            <select class="select date-select" name="mes">
        ...
        <input id="btnSaveVacuna" type="submit" value="grabar datos">
    </form>
</div>
