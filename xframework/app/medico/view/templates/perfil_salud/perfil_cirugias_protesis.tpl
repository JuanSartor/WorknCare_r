...
<div id="div_cirugias_protesis">
    ...
    <section class="profile patient">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form id="cirugia_form" action="{$url}save_cirugias_m.do" method="post"  style="display:none"  onsubmit="return false;">
                    </form>

                    <form id="protesis_form" action="{$url}save_protesis_m.do" method="post"  style="display:none"  onsubmit="return false;">
                    </form>

                    <section class="data-form health-profile relative" id="health-profile">
                       {* <h1 class="section-header icon-svg circle surgery text-center">{"Cirugías e intervenciones"|x_translate}</h1>*}
                        <div class="form patient-file">
                            ...
                            <form id="cirugia_modificaciones_form" action="{$url}save_modificaciones_cirugias_m.do" method="post"   onsubmit="return false;">
                            ...
                            <form id="protesis_modificaciones_form" action="{$url}save_modificaciones_protesis_m.do" method="post"   onsubmit="return false;">
                                <input type="hidden" name="paciente_idpaciente" value="{$paciente.idpaciente}"/>  
