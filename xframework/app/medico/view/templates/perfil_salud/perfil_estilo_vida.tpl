...
<form id="perfil_estilo_vida_form" action="{$url}save_estilo_vida_medico_form.do" method="post" onsubmit="return false;">
    ...
    <div class="row">
        ...
        <article class="col-md-6 ">
            <div class="card card-blue-light" id="article_consumo_azucares">
                ...
                <div class="card-body">
                    <ul>
                        <li><label class="checkbox" for="reg-p"><input value="0" type="checkbox" id="reg-p" data-toggle="checkbox" class="custom-checkbox">{"Regularmente en grandes cantidades"|x_translate}</label></li>
                        <li><label class="checkbox" for="reg-m"><input value="1" type="checkbox" id="reg-m" data-toggle="checkbox" class="custom-checkbox">{"Regularmente en pocas cantidades"|x_translate}</label></li>
                        <li><label class="checkbox" for="ow-m"><input value="2" type="checkbox" id="ow-m" data-toggle="checkbox" class="custom-checkbox">{"De vez en cuando en pocas cantidades"|x_translate}</label></li>
                        <li><label class="checkbox" for="ow-p"><input value="3" type="checkbox" id="ow-p" data-toggle="checkbox" class="custom-checkbox">{"De vez en cuando en grandes cantidades"|x_translate}</label></li>
                    </ul>						
                </div>
            </div>
        </article>					
