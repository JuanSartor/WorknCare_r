...
$(document).ready(function () {
    ...
    $("#idenfermedad").change(function () {
        updateComboBox("#idenfermedad", 'idtipoEnfermedad', 'ManagerTipoEnfermedad', 'getCombo', 0, x_translate('Patología'));
    });
    ...
    $("#btnAgregarPatologia").click(function () {
        ...
        if ($("#otro_tipo_enfermedad").val() != "") {
            ...
            x_doAjaxCall(
                    'POST',
                    BASE_PATH + 'add_enfermedades_actuales_m.do',
...
//enfermedades seleccionadas combo
            if ($("#idenfermedad").val() != "" && $("#idtipoEnfermedad").val() != "") {
                $("#antecedentes_form_2").spin("large");
                x_doAjaxCall(
                        'POST',
                        BASE_PATH + 'add_enfermedades_actuales_m.do',
