    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <form class="form patient-file light-grey" role="form"  id="antecedentes_form_1" action="{$url}save_perfil_antecedentes_m.do" method="post"  onsubmit="return false;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="flat-input small" id="peso"  name="peso" {if $paciente.edad_anio<18} required{/if} value="{$record.peso}">{"grs"|x_translate}
                            </div>
                            <div class="form-group">
                                <span class="question small">{"Talla"|x_translate}</span>
                                <input type="number" class="flat-input small" id="talla" name="talla" {if $paciente.edad_anio<18} required{/if} value="{$record.talla}">{"cm"|x_translate}
                            </div>
                            <div class="form-group">
                                <span class="question small">{"Per. Cef."|x_translate}</span>
                                <input type="number" class="flat-input small" id="per_cef" name="per_cef" {if $paciente.edad_anio<18} required{/if} value="{$record.per_cef}">{"cm"|x_translate}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <form class="form patient-file" role="form"  id="antecedentes_form_2" action="{$url}save_perfil_antecedentes_m.do" method="post"  onsubmit="return false;">
        ...
        <form class="form patient-file" id="form_patologia_familiar" role="form" method="post" action="{$url}add_patologia_familiar_m.do"  onsubmit="return false;">
            ...
            <div class="row user-select">
                ...
                {*<div class="clearfix hidden-md hidden-lg"><p>&nbsp;</p></div>*}
                <div class="col-md-4">
                    ...
                    <div class="tagsinput-primary">
                        ...
                        <script>
                            var func_delete = function(event) {
                                ...
                                x_doAjaxCall(
                                        'POST',
                                        BASE_PATH + 'delete_patologia_familiar_m.do',
                                        'id=' + id,
                                        function(data) {
                                            x_alert(data.msg);
                                            if (data.result) {
                        ...
                        {*<input name="tagsinput" id="tag_input" class="tagsinput" data-role="tagsinput" value="" />*}
                    </div>
