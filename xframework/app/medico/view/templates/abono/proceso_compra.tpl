...
<div class="container">
    ...
    <section class="sign-up">
        ...
        <div class="tab-content" id="tabs-proceso">
                ...
                <section class="professional account-type container text-center">
                    ...
                    <div class="row highlights">
                        <div class="col-md-8 col-center col-sm-12 plan-highlights">
                            <p class="text-center">
                                {"Ideal para profesionales con alta demanda y requerimiento de"|x_translate}<br /> 
                                {"sus pacientes fuera del consultorio"|x_translate}
                            </p>
                            ...
                            <div class="row special-features">
                                ...
                                <div class="col-md-4 col-md-offset-1">
                                    <ul>
                                        ...
                                        <li><span class="dp-video">{"Video Consulta"|x_translate}</span></li>
            ...
            <input type="text" class="form-control" placeholder='{"Nombre"|x_translate}'>
            </div>
            <div class="form-group data-field">
            <input type="text" class="form-control" placeholder='{"Apellido"|x_translate}'>
            </div>
            <div class="form-inline">
            <p>Sexo</p>
            <div class="form-group data-field">
            <input type="radio" class="form-control" name="gender" id="female" value='{"femenino"|x_translate}' />
            <label for="female">Femenino</label>
            </div>
            <div class="form-group data-field">
            <input type="radio" class="form-control" name="gender" id="male" value='{"masculino"|x_translate}' />
            <label for="male">Masculino</label>
            </div>
            </div>
            <div class="form-group data-field">
            <select class="form-control select select-primary select-block mbl" name='{"speciality"|x_translate}' id="speciality">
            <option value="especialidad">Especialidad</option>
            </select>
            </div>
            <div class="form-group data-field">
            <select class="form-control select select-primary select-block mbl" name='{"sub-speciality"|x_translate}' id="sub-speciality">
                ...
                <div class="purchase-summary">
                    <div class="row">
                            ...
                            <div class="table-responsive">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>&euro;{$MONTO_CUOTA} / mois</td>
                                        <td class="stotal">&euro;{$MONTO_CUOTA}<br></td>
                                    </tr>
                                    <tr>
                                        <td><a class="promo-code-btn" href="#">{"Tengo un código promocional"|x_translate}</a></td>
                                        <td></td>
                                        <td></td>
                                        <td class="total">&euro;{$MONTO_CUOTA}</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="col-md-2 col-md-offset-1 text-center total">
                            ...
                            <div id="div_mercado_pago" style="display:none">
                                ...
                                <a class="uppercase next" role="button"  href="javascript:;" id="btnContinuarMP">{"Continuar"|x_translate}</a>


                            </div>
                            <div id="div_otro_medio_pago" style="display:none">
                                <a class="uppercase next" role="button" href="javascript:;" id="btnContinuar">{"Continuar"|x_translate}</a> 
                            </div>
                            {*else*}
                            {*<a class="uppercase next" role="button" href="javascript:;" id="btnContinuar">{"Continuar"|x_translate}</a>*}
                            {*/if*}
                    ...
                    <div class="payment-options">
                        <div class="row relative" id="div_metodo_pago">
                            ...
                            {*
                            <div class="col-md-4">
                            <p>{"Transferencias / Depósitos Bancarios"|x_translate}</p>
                            <button data-modal="yes" class="wire-transfer"><img src="{$IMGS}santander_logo.png" title="Santander Río" class="img-responsive"></button>
                            <div class="modal-payment-information hidden">
                            <div class="payment-information">
                            <div class="col-md-8 grey-15 payment-details box">
                            <div>
                            <img src="{$IMGS}santander_logo.png" title="Santander Río" width="150" class="img-responsive">
                            <p>{"Podés abonar tus pagos por Depósito o Transferencia Bancaria:"|x_translate}</p>
                            <br />
                            <div>{"Datos para depósito y/o transferencia:"|x_translate}</div>
                            <div>{"Entidad Bancaria:"|x_translate} <strong>Banco Santander Río</strong></div>
                            <div>{"Titular de la cuenta:"|x_translate} <strong>DoctorPlus S.A.</strong></div>
                            <div>{"Tipo de cuenta:"|x_translate} <strong>{"Cuenta Corriente"|x_translate}</strong></div>
                            <div>{"Nro. de cuenta:"|x_translate} <strong>895749</strong></div>
                            <div>{"Sucursal:"|x_translate} <strong>359</strong></div>
                            ...
                            <div class="col-md-4">
                            <p>{"Débito en Cuenta Bancaria"|x_translate}</p>
                            ...
                            <p>{"El débito automático es sólo para cuentas bancarias. No realizamos débitos de tarjetas de crédito con este medio de pago."|x_translate}</p>
                            <br />
                            <p>{"Para pagar por débito automático siga estos pasos:"|x_translate}</p>
                            </div>
                            </div>
                            <div class="col-md-4 grey-10 requisites box">
                            <div>
                            <p class="dp-file">{"Requiere informar el pago"|x_translate}</p>
                            </div>
                            <hr >
                            <div>
                            <p class="dp-time">{"5 días hábiles."|x_translate}</p>
                            </div>
                            </div>
                            <div class="clearfix"></div>
                            </div>
                ...
                x_doAjaxCall(
                        ...
                        function (data) {
                            if (data.result) {
                                ...
                                x_loadModule('abono', 'pago_tarjeta', 'idsuscripcion=' + data.id, 'div_metodo_pago');
