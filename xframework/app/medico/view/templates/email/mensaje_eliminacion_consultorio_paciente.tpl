                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:16px" valign="middle">
                                                    <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold;">
                                                        ...
                                                        <a href="{$url}panel-paciente/profesionales/{$medico.idmedico}-{$medico.nombre|str2seo}-{$medico.apellido|str2seo}.html"  class="rsp-lnk" target="_blank"  style="color:#31A592; text-decoration:none">{$medico.tituloprofesional} {$medico.nombre} {$medico.apellido}</a> a éliminé le cabinet de consultation.
                                ...
                                <tr>
                                    <td style="padding:16px">
                                        <p style="color:#415B70; font-size:16px; font-weight:bold; font-family:'Helvetica', Arial, sans-serif">
                                            Votre Rendez-vous  Nº {$turno.idturno} -  {$turno.fecha_str}hs est annulé
                                        </p>
