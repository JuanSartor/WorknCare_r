                            ...
                            <td style="padding:0 16px 16px 16px">
                                <table width="100%" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding:16px" valign="middle">
                                                        <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold;">
                                                            <a href="{$url}panel-paciente/profesionales/{$medico.idmedico}-{$medico.nombre|str2seo}-{$medico.apellido|str2seo}.html"  class="rsp-lnk" target="_blank"  style="color:#31A592; text-decoration:none">{$medico.titulo_profesional.titulo_profesional} {$medico.nombre} {$medico.apellido}</a> a changé l'heure de votre  <a href="{$url}patient/video-consultation/salle-attente.html" class="rsp-lnk" target="_blank"  style="color:#31A592; text-decoration:none">Vidéo Consultation</a>!
                                                        </p>
                                                        <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold;">
                                                            Le professionnel vous attendra dans son  <a href="{$url}patient/video-consultation/salle-attente.html" class="rsp-lnk" target="_blank"  style="color:#31A592; text-decoration:none">Cabinet Virtuel</a> {if $videoconsulta.aceptar_en=="0"}¡MAINTENANT!{else} {if $smarty.now|date_format:"%d" != $videoconsulta.inicio_sala|date_format:"%d"} le {$dia_nombre} {$videoconsulta.inicio_sala|date_format:"%d"} {else} aujourd'hui {/if}à {$videoconsulta.inicio_sala|date_format:"%H:%M"}hs.{/if}
                                                        </p>
                                                        <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif;">
                                                            Vidéo Consultation  Nº{$videoconsulta.numeroVideoConsulta} - Motif: <span style="font-size:16px;">{$motivoVideoConsulta}</span>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td style="padding:16px">
                                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                                <a href="{$url}patient/video-consultation/salle-attente.html" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">Entrez dans son Cabinet Virtuel</a>
                                            </p>
                                            {*<p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                            ou suivez ce lien pour y accéder
                                            </p>
                                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
