                    ...
                    <tr>
                        <td style="padding:16px 16px 0px 16px">
                            ...
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                Vous devez confirmer votre email {$usuario.email} pour utiliser votre compte sur WorknCare.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0 16px">
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                <a href="{$url}activacion/{$hash}.html" target="_blank" title="Confirmez votre email ici" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">confirmer email</a>
                            </p>
                            {*<p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
