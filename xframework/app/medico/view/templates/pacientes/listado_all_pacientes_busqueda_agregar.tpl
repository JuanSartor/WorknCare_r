{if $listado_mis_pacientes.rows && $listado_mis_pacientes.rows|@count > 0}
    ...
    {if $listado_mis_pacientes.rows && $listado_mis_pacientes.rows|@count > 0}
        {x_paginate_loadmodule_v2  id="$idpaginate" modulo="pacientes" submodulo="listado_all_pacientes_busqueda" container_id="lista-pacientes-full" params="query_str=$query_str"}
    {/if}
...
{else}
    <div class="text-center">
        {"No hay pacientes con ese criterio de búsqueda"|x_translate}
    </div>
