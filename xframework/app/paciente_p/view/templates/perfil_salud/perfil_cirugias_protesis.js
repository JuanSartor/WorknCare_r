$(document).ready(function() {
    ...
    $("#btnGrabarDatos").click(function() {
        ...
        x_doAjaxCall(
                'POST',
                BASE_PATH + 'posee_cirugias_protesis.do',
   ...
   actualizar_menu_status_perfilsalud();
        ...
        if ($("#listado_cirugias").val() == 1) {
            if ($("#check_cirugia_si").is(":checked")) {
                ...
                x_doAjaxCall(
                        'POST',
                        BASE_PATH + 'delete_all_cirugias.do',
                        'id=' + $("#idpaciente").val(),
                        function(data) {
        ...
        if ($("#listado_protesis").val() == 1) {
            if ($("#check_protesis_si").is(":checked")) {
                ...
                x_doAjaxCall(
                        'POST',
                        BASE_PATH + 'delete_all_protesis.do',
                        'id=' + $("#idpaciente").val(),
                        function(data) {
    ...
    $(".agregar_cirugias").click(function() {
        ...
        $.each($("#div_add_cirugia").find("input"),
                function(index, value) {
                    ...
                    } else if ($element_input.attr("name") != "idperfilSaludCirugiasProtesis") {
                    ...
                    function(data) {
                        ...
                        if (data.result) {
                            str = "<div class=\"row\" id=\"div_row_" + data.entitie.idperfilSaludCirugias + "\">" +
                                    ...
                                    " <input class=\"input-inline\" type=\"text\" name=\"cirugia\" placeholder='"+x_translate("Cirugía")+"' value=\"" + data.entitie.cirugia + "\" style=\"margin-top:6px\">" +
                                    "</div>" +
                                    "</div>" +
                                    ...
                                    "<tr>" +
                                    "<td><input class=\"input-inline\"  type=\"text\" placeholder='"+x_translate("¿Cuándo?")+"'  value=\"" + data.entitie.cuando + "\" name=\"cuando[" + data.entitie.idperfilSaludCirugias + "]\"></td>" +
                                    "<td><input class=\"input-inline\"  type=\"text\" placeholder='"+x_translate("¿Cómo?")+"'  value=\"" + data.entitie.como + "\" name=\"como[" + data.entitie.idperfilSaludCirugias + "]\"></td>" +
                                    "<td><button class=\"dp-trash delete delete_cirugia\" data-id=\"" + data.entitie.idperfilSaludCirugias + "\"></button></td>" +
                                    "</tr>" +
                                    "<tr>" +
                                    "<td><input class=\"input-inline\"  type=\"text\" placeholder='"+x_translate("¿Dónde?")+"' value=\"" + data.entitie.donde + "\" name=\"donde[" + data.entitie.idperfilSaludCirugias + "]\"></td>" +
                                    "<td><input class=\"input-inline\"  type=\"text\" placeholder='"+x_translate("¿Por Que?")+"' value=\"" + data.entitie.porque + "\" name=\"porque[" + data.entitie.idperfilSaludCirugias + "]\"></td>" +
                                    "<td></td>" +
                                    "</tr>" +
                    ...
                    function(data) {
                        ...
                        if (data.result) {
                            str = "<div class=\"row\" id=\"div_row_protesis_" + data.entitie.idperfilSaludProtesis + "\">" +
                                    ...
                                    "<tbody>" +
                                    "<tr>" +
                                    "<td><input class=\"input-inline\" name=\"tipo_aparato[" + data.entitie.idperfilSaludProtesis + "]\" type=\"text\" value=\"" + data.entitie.tipo_aparato + "\" placeholder='"+x_translate("Tipo de aparato")+"'></td>" +
                                    "<td><input class=\"input-inline\" name=\"desde_cuando[" + data.entitie.idperfilSaludProtesis + "]\" type=\"text\" value=\"" + data.entitie.desde_cuando + "\" placeholder'"+x_translate("¿Desde cuándo?")+"'></td>" +
