        ...
        <div class="col-md-12">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active">{"Control visual"|x_translate}</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="container pul-control-visual">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-11 col-center">
            <div class="control-visual-card">
                <form  id="control-visual-oftalmologico" method="post" action="{$url}save_control_visual_oftalmologico.do" onsubmit="return false;">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-11 col-center">
            <div class="control-visual-card">
                <form  id="control-visual-anteojos" method="post" action="{$url}save_control_visual_anteojos.do" onsubmit="return false;">
                    <div class="card-select-top">
...
{literal}
    <script>
        $(function () {
            ...
            if ($("#idperfilSaludControlVisual").val() == "") {
                x_doAjaxCall(
                        "POST",
                        BASE_PATH + "process_control_visual.do",
                        "",
                        function (data) {
                            $("#idperfilSaludControlVisual").val(data.id);
            ...
            $('#add-patologia').on('click', function (event) {
                ...
                if (parseInt(id) > 0) {
                    ...
                    x_doAjaxCall(
                            "POST",
                            BASE_PATH + "add_control_visual_antecedentes.do",
    ...
    //grabar otra patologia y generar el tagsinput
            ...
            $('#patologia-tag').on('beforeItemRemove', function (event) {
                ...
                x_doAjaxCall(
                        'POST',
                        BASE_PATH + 'delete_control_visual_antecedentes.do',
                        'id=' + id,
                        function (data) {
            ...
            $('#patologia-actual-add').on('click', function (event) {
                ...
                if (text != "") {
                    ...
                    x_doAjaxCall(
                            "POST",
                            BASE_PATH + "add_control_visual_patologia_actual.do",
            ...
            $('#patologia-actual-tag').on('beforeItemRemove', function (event) {
                ...
                x_doAjaxCall(
                        'POST',
                        BASE_PATH + 'delete_control_visual_patologia_actual.do',
                        'id=' + id,
                        function (data) {
                ...
                if ($('#patologia-actual-tag').tagsinput('items').length > 0) {
                    jConfirm({
                        ...
                        confirm: function () {
                            x_doAjaxCall(
                                    'POST',
                                    BASE_PATH + 'delete_control_visual_all_patologias_actuales.do',
