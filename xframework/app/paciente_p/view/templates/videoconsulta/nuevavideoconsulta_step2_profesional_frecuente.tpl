    ...
    <script>
        ...
        $(function () {
            ...
            $('#as_obrasocial').autocomplete({
                zIndex: 10000,
                serviceUrl: BASE_PATH + 'paciente_p.php?action=1&modulo=videoconsulta&submodulo=obrasocial_autosuggest',
                ...
                x_doAjaxCall(
                        ...
                        function (data) {
                            if (data.result) {
                                ...
                                x_loadModule('videoconsulta', 'nuevavideoconsulta_step2_profesional_frecuente_resultados', "idvideoconsulta=" + $("#idvideoconsulta_f").val() + "&do_reset=1", "videoconsulta-step-container", BASE_PATH + "paciente_p");
