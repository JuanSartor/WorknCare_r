...
<section class="container cs-nc-p2 cs-nc-profesionales-en-la-red">
    ...
    <div class="cs-nc-p2-inner">
        ...
        <form name="f_busqueda" id="f_busqueda" method="POST" role="form" onsubmit="return false;">
            ...
            {if $paciente.is_paciente_empresa!="1" || $paciente.vc_disponibles==0}
                <div id="container_rango_precios">
                    {include file="videoconsulta/rango_precios_profesionales_red.tpl"}
                </div>
            {/if}
...
{literal}
    <script>
        $(function () {
            ...
            //recargamos el modulo de rango de precios por defecto - si no tiene consultas libres disponibles
            if ($("#container_rango_precios").length > 0) {
                $(".select-categoria").click(function () {
                    $("#idpais_f").val($("#idpais").val());
                    $("body").spin();
                    x_loadModule('videoconsulta', 'rango_precios_profesionales_red', $("#f_busqueda").serialize(), 'container_rango_precios', BASE_PATH + "paciente_p").then(function () {
                        $("body").spin(false);
                    });
                });
            }
            ...
            $("#btnContinuar").click(function () {
                ...
                x_doAjaxCall(
                        ...
                        function (data) {
                            ...
                            if (data.result) {
                                if (tipo_consulta == 1) {
                                    x_loadModule('videoconsulta', 'nuevavideoconsulta_step2_profesional_frecuente_resultados', 'idvideoconsulta=' + $("#idvideoconsulta").val(), 'videoconsulta-step-container', BASE_PATH + "paciente_p").then(function () {
                                        $("body").spin(false);
                                    });
                                } else {
                                    x_loadModule('videoconsulta', 'nuevavideoconsulta_step3', 'idvideoconsulta=' + $("#idvideoconsulta").val(), 'videoconsulta-step-container', BASE_PATH + "paciente_p").then(function () {
                                        $("body").spin(false);
                                    });
                                }
                            } else {
