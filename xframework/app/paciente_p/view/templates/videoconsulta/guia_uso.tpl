<section class="consulta-express-slider-holder hidden-xs hidden-sm">
                        ...
                        <div class="item-3-body item-3-back-3">
                            ...
                            <div class="item-2-content-holder">
                                <div class="item-2-content">
                                    ...
                                    <p>
                                        {"¡DoctorPlus lo hace posible!"|x_translate}
                                        {"Tu médico te atiende en vivo y en directo a traves de una Video Consulta."|x_translate}
                                    </p>
                ...
                <div class="item-2 back-2">
                    <div class="item-inner item-2-fig-holder">
                        <div class="item-2-stripes">
                            ...
                            <div class="item-2-content-holder">
                                <div class="item-2-content">
                                    <h4>{"¡Conectándonos fácilmente cuidamos mejor nuestra salud!"|x_translate}</h4>
                                    <p>
                                        {"Comience a disfrutar de los beneficios de DoctorPlus."|x_translate} 
                                        {"La nueva red de e-Salud que conecta a médicos y pacientes"|x_translate}
                                    </p>
                                </div>
                            </div>
                        </div>
