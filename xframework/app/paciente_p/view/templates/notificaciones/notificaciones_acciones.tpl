            ...
            x_doAjaxCall(
                    ...
                    function (data) {
                        ...
                        if (data.result) {
                            ...
                            x_loadModule('notificaciones', target_listado, 'do_reset=1', 'div_notificaciones_list', BASE_PATH + "paciente_p", "", actualizar_notificaciones($("#paciente_seleccionado").val()));
                        } else {
                            x_alert(data.msg);
                        }
                    }
