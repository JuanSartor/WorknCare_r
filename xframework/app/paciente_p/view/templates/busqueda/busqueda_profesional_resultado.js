$(function () {
        ...
        x_doAjaxCall(
                ...
                function (data) {
                    if (data.result) {
                        ...
                        $("span.agregar-favorito[data-id=" + id + "]").toggle();
                        $("span.eliminar-favorito[data-id=" + id + "]").toggle();
                    } else {
                        x_alert(data.msg);
                    }
                }
    ...
    x_loadModule("busqueda", "busqueda_profesional_resultado_modulo", "do_reset=1", "modulo_listado_consultorios", BASE_PATH + "paciente_p");
});
