...
<link rel="stylesheet" href="{$url}xframework/app/themes/dp02/css/checkrtc.css">
    ...
    <input type="hidden" name="check_redirect" id="check_redirect" value="{if $smarty.request.goto!=""}{$smarty.request.goto}{else}{$url}{/if}">
        <input type="hidden" name="HTTP_REFERER" id="HTTP_REFERER" value="{$HTTP_REFERER}">
                ...
                <div class="container exito" style="display:none" id="resultOK">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                            ...
                            {*<h4><a href="javascript:history.back();">{"volver"|x_translate}<a></h4>*}
                        </div>
                    </div>
                </div>
                                                                                                                                                             ...
                                                                                                                                                             startTest(tokSession)
                                                                                                                                                                    .then(function (DetectRTC) {
                                                                                                                                                                        ...
                                                                                                                                                                        /*
                                                                                                                                                                         ...
                                                                                                                                                                         $('.testResults').delay(500).fadeIn(1500);
                                                                                                                                                                         if (resultado > 0) {
                                                                                                                                                                         $("#resultKO").show();
                                                                                                                                                                         ...
                                                                                                                                                                         // Si fue OK el test, espero 2 segundos y redirecciono
                                                                                                                                                                         setTimeout(function(){
                                                                                                                                                                         window.location.href = $("#check_redirect").val();
                                                                                                                                                                         }, 4000);
                                                                                                                                                                         }
                                                                                                                                                                         };
