...
<div class="mul-datos-administrador-box">
    ...
    <section class="notification-settings form edit white">
        <div class="container">
            ...
            <div class="okm-row">
                <form id="f_save" name="f_save" action="{$url}panel-paciente/datos-administrador/guardar_celular_email.do" method="POST" onsubmit="return false;">
                    <div class="col-md-5 col-md-offset-1">
                        <div class="field-edit border email">
                            <input type="text" maxlength="50" id="cambioEmail" name="email" placeholder="ejemplo@mail.com" {if $paciente_titular.cambioEmail!=""}value="{$paciente_titular.cambioEmail}"{else}value="{$paciente_titular.email}"{/if}>
                    ...
                    <div class="col-md-5">
                        <div class="field-edit border smartphone">
                            <input type="tel" id="numeroCelular" name="numeroCelular"  value="{$paciente_titular.numeroCelular}">
            ...
            <div id="desplegable-validacion" class="relative">
                <div class="okm-row mul-slide-validar-box" id="mul-validar-cel">
                    <div class="validar-cell-box">
                        ...
                        <div class="validar-cell-content relative">
                            <span id="validar_cel_msg" class="validar-cell-telefono">{"Le enviamos un mensaje de texto (SMS) con el código de validación de su celular al número"|x_translate}  <span id="cambio_nroCelular">{$paciente.cambioCelular}</span>.
                            </span>
                            <p>
                ...
                {if $paciente_titular.numeroCelular!="" && $paciente_titular.celularValido=="0"}
                    <div class="okm-row mul-slide-validar-box relative" id="mul-validar-cel-revalidar">
                        <div class="validar-cell-box relative ">
                            ...
                            <div class="validar-cell-content">
                                <span class="validar-cell-telefono">{"Celular:"|x_translate} {$paciente_titular.numeroCelular}</span>
                                <p class="mul-red">
                                    {"Su número de celular aún no se encuentra validado y no podrá recibir notificaciones."|x_translate}</p>
                                <p>
                                    {"Si quiere generar el código nuevamente"|x_translate} <a href="javascript:;" class="generateCodigoCelular">{"click aquí"|x_translate}</a> 
                                </p>
                                <div class="validar-cell-action-box">
                                    <input type="text" class="codigo-cell " name="codigo-cell" placeholder='{"INGRESE CODIGO"|x_translate}'>
                                </div>
                ...
                <div class="okm-row mul-slide-validar-box" id="mul-validar-mail">
                    <div class="validar-cell-box relative">
                        ...
                        <div class="validar-cell-content">
                            <span id="validar_mail_msg" class="validar-cell-telefono">{"Le enviamos un email con el código de validación de su email a la casilla"|x_translate} <span id="cambio_email">{$paciente_titular.cambioEmail}</span> .
                            </span>
                            <p>
                ...
                {if $paciente_titular.cambioEmail!="" && $paciente_titular.cambioEmail!=$paciente_titular.email} 
                    <div class="okm-row mul-slide-validar-box relative" id="mul-validar-mail-revalidar">
                        <div class="validar-cell-box relative ">
                            <h2>Validar casilla de correo <a class="mul-validar-close-triger" href="#"><i class="icon-doctorplus-cruz"></i></a></h2>
                            <div class="validar-cell-content">
                                <span class="validar-cell-telefono">{"Casilla de correo:"|x_translate} {$paciente_titular.cambioEmail}</span>
                                <p class="mul-red">
    ...
    <section class="password-change form edit">
        <div  id="section-pw" class="container">
            <h2 class="text-center">{"Contraseña"|x_translate}</h1>
                <div class="row">
                    <form id="f_pass" name="f_pass" action="{$url}panel-paciente/datos-administrador/cambiar_password.do" method="post">
                        ...
                        <div class="col-md-5 col-md-offset-1" id="password-block">
                            ...
                            <div class="mul-input-clave-box">
                                <div class="field-edit dp-lock">
                                    <input type="password" id="f_oldPassword" maxlength="50" placeholder='{"Contraseña anterior"|x_translate}'>
                            ...
                            <div class="mul-input-clave-box mapc-input-line">
                                <div class="field-edit dp-lock">
                                    <input type="password" id="f_newPassword" class="pul-np-dis input_password_strength" maxlength="50" placeholder='{"Establecer nueva contraseña"|x_translate}'>
                                    <span class="btnShowPassword" title='{"Mostrar contraseña"|x_translate}'><i  class="fa fa-eye"></i></span>
                                </div>
                            ...
                            <div class="mul-input-clave-box">
                                <div class="field-edit dp-lock">
                                    <input type="password" id="f_rePassword" class="input_password_strength" maxlength="50" placeholder='{"Repita la nueva contraseña"|x_translate}'>
                                    <span class="btnShowPassword" title='{"Mostrar contraseña"|x_translate}'><i  class="fa fa-eye"></i></span>
                                </div>
        ...
        $(document).ready(function () {
                ...
                x_sendForm(
                        ...
                        function (data) {
                            ...
                            if (data.result && data.celularValido == "0") {
                                ...
                                $("#cambio_nroCelular").val($("#numeroCelular").val());
                                $('#mul-validar-cel').slideDown();
                            }
                            if (data.result && data.emailValido == "0") {
                                //seteamos el msg con el numero ingresado
                                $("#cambio_email").html($("#cambioEmail").val());
            ...
            $(".validarCodigoEmail").click(function () {
                ...
                if (codigo == "") {
                    ...
                    x_doAjaxCall(
                            'POST',
                            BASE_PATH + 'validar_codigo_email.do',
            ...
            $(".generateCodigoEmail").click(function () {
                ...
                x_doAjaxCall(
                        'POST',
                        BASE_PATH + 'generar_codigo_email.do',
                        "",
                        function (data) {
                            x_alert(data.msg);
                            $("#desplegable-validacion").spin(false);
