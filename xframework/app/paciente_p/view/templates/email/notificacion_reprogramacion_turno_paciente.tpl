                                                    ...
                                                    <table width="100%" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">Nous vous informons que le {if $turno_videoconsulta==1} rendez-vous de Vidéo Consultation {else} rendez-vous au cabinet{/if} avec le patient {$paciente_turno.nombre} {$paciente_turno.apellido} 
                                                                    du {$fecha_turno}hs est reporté  au {$fecha_turno_nuevo}hs
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td style="padding:16px;text-align:center;">
                                                    <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                                        <a href="{$url}medico.php?&modulo=agenda&submodulo=agenda_diaria&fecha={$turno_nuevo.fecha|date_format:"%d/%m/%Y"}&idconsultorio={$turno_nuevo.consultorio_idconsultorio}" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">Voir l'agenda</a>
                                                    </p>
                                    ...
                                    <td>
                                        <table width="100%" align="left" bgcolor="#ffffff" border="0" valign="top" cellpadding="6" cellspacing="0" style="border-collapse:collapse">
                                            <tr align="left">
                                                ...
                                                <td align="left">
                                                    <p style="color:#415B70; font-size:17px; font-family:'Helvetica', Arial, sans-serif">
                                                        <span style="text-decoration: line-through;">{$fecha_turno}hs</span>  -> {$fecha_turno_nuevo}hs
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
