                                ...
                                <tr>
                                    ...
                                    <td style="padding:16px" valign="middle">
                                        <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold;">
                                            Nous avons bien reçu votre demande de modification de l'email associé à votre compte sur DoctorPlus. Veuillez utiliser le code suivant pour valider cette nouvelle adresse email:
                                        </p>
                                    </td>
                                </tr>
                            </table>
