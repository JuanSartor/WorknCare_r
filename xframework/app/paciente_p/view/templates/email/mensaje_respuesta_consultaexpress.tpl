                        ...
                        <td style="padding:0 16px 16px 16px">
                            <table width="100%" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:16px" valign="middle">
                                                    <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold;">
                                                        <a href="{$url}panel-medico/mis-pacientes/{$paciente.idpaciente}-{$paciente.nombre|str2seo}-{$paciente.apellido|str2seo}/" class="rsp-lnk" target="_blank" style="color:#21B796; text-decoration:none">{$paciente.nombre} {$paciente.apellido}</a> a répondu à votre   <a href="{$url}panel-medico/consultaexpress/abiertas.html" class="rsp-lnk" target="_blank" style="color:#21B796; text-decoration:none"> Conseil</a>
                                                    </p>
                                ...
                                <tr>
                                    <td style="padding:16px">
                                        <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                            <a href="{$url}panel-medico/consultaexpress/abiertas.html" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">Voir Conseil </a>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
