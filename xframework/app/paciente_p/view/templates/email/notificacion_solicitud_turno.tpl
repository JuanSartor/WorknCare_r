                                            ...
                                            <tr>
                                                <td style="padding:0 16px 16px 16px">
                                                    <table width="100%" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                                                        <tr>
                                                            <td width="60">
                                                                {if $paciente_turno.imagen.perfil!=""}
                                                                    <img src="{$paciente_turno.imagen.perfil}" alt="{$paciente_turno.nombre} {$paciente_turno.apellido}" style="border:none; border-radius:50%;"/>
                                                                {else}
                                                                    <img src="{$IMGS}extranet/noimage-paciente.jpg" alt="{$paciente_turno.nombre} {$paciente_turno.apellido}" style="border:none; border-radius:50%;"/>
                                                                {/if}
                                                            </td>
                                                            <td style="padding:16px" valign="middle">
                                                                <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold;">
                                                                    {if $turno_videoconsulta}
                                                                        <a href="{$url}panel-medico/mis-pacientes/{$paciente.idpaciente}-{$paciente.nombre|str2seo}-{$paciente.apellido|str2seo}/" class="rsp-lnk" target="_blank" style="color:#31A592; text-decoration:none">{$paciente_turno.nombre} {$paciente_turno.apellido}</a> souhaite réaliser une Vidéo Consultation sur rendez-vous avec vous.
                                                                    {else}
                                                                        <a href="{$url}panel-medico/mis-pacientes/{$paciente.idpaciente}-{$paciente.nombre|str2seo}-{$paciente.apellido|str2seo}/" class="rsp-lnk" target="_blank" style="color:#31A592; text-decoration:none">{$paciente_turno.nombre} {$paciente_turno.apellido}</a> il a un rendez-vous confirmé dans son cabinet presentiel.
                                                                    {/if}
                                                                </p>
