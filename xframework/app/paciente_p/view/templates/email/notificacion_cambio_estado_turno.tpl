                                ...
                                <tr>
                                    <td>
                                        {if $turno_estado!="Patient absent"}
                                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">Nous vous informons que le {if $turno_videoconsulta==1} rendez-vous de Vidéo Consultation {else} rendez-vous au cabinet {/if} est {$turno_estado} pour </p>
                                        {else}
                                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">Nous vous informons que le {if $turno_videoconsulta==1} rendez-vous de Vidéo Consultation {else} rendez-vous au cabinet{/if} est {$turno_estado} pour</p>
