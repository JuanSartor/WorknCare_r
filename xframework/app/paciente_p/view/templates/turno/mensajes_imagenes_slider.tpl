<link rel="stylesheet" type="text/css" href="{$url}xframework/app/paciente_p/view/css/mensajes-imagenes-slider.css?v={$smarty.now|date_format:"%j"}" />
<div class="modal-header">
    <span id="close-ver-archivo" style="float: right; cursor:pointer;">X</span>
    <div class="modal-title">
        <h5>{"Archivos adjuntos"|x_translate}:</h5>
    </div>
</div>
