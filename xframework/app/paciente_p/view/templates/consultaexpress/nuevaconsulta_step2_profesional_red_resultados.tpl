...
<div id="div_profesionales_red_list">
            ...
            <div class="row ce-nc-p2-res">
                            ...
                            <ul>
                                <li class="selectall">
                                    <a href="javascript:;" class="a-pointer" id="btnEliminarMedicos">
                                        ...
                                        <span class="label">{"Eliminar"|x_translate}</span>
                                    </a>
                                </li>
                                ...
                                <div id="medico-resultado-{$medico.idmedico}" class="resultados-list-left" style="cursor:default;">
                                    ...
                                    <div class="resultados-list-left-content">
                                        ...
                                        <p>
                                            ...
                                            {if $medico.idconsultorio==""}<br><span class="ce-sin-consultorio">{"No declara dirección de consultorio"|x_translate}</span>{/if}
                                        </p>
                                    </div>
                                    <div class="resultados-list-left-ratting">
                                        ...
                                        *}
                                        ...
                                        {else}
                                        <a class="ratting-like {if $medico.favorito=="1"}selected{/if}"  data-id="{$medico.idmedico}" href="javascript:;"><i class="icon-doctorplus-corazon"></i></a>           
                                        {/if}
                                        <p>
                                    ...
                                    <div class="resultados-list-right">
                                        <div class="resultados-list-right-price">
                                            <span>
                                                {if $medico.valorPinesConsultaExpress>"0"}
                                                &euro;{$medico.valorPinesConsultaExpress}
                                                {else}
                                        ...
                                        <div class="resultados-list-right-action">
                                            ...
                                            <a  href="javascript:;" role="button" {if $medico.valorPinesConsultaExpress>"0"} class="select-profesional-consulta" {/if} data-id="{$medico.idmedico}">
                ...
                <div class="cs-nc-listado-p2-paginador2-holder">
                   ...
                   <div class="cs-nc-listado-p2-siguiente" style="float:right">
                        ...
                        submodulo="nuevavideoconsulta_step2_profesional_red_resultados" 
                        container_id="div_profesionales_red_list"}
                ...
                <div class="sin-registros">
                    ...
                    <p><strong>{"No registramos profesionales"|x_translate}</strong> {"en los parámetros de búsqueda"|x_translate}.</p>
                        ...
                        $.each(data, function (index, value) {
                            ...
                            if (value.hasOwnProperty('idconsultorio')) {
                                ...
                                var marker = new google.maps.Marker({
                                    ...
                                    icon: ICON_BLUE,
                                    draggable: false,
                                    title: x_translate("Carte des cabinets")
                                });
    ...
    <script>
            ...
            //seleccionar medico de consulta express desde gmap
            var setProfesionalConsulta = function (idmedico) {

                x_doAjaxCall(
                        'POST',
                BASE_PATH + 'set_medico_consultaexpress.do',
                'medico_idmedico=' + idmedico + "&idconsultaExpress=" + $("#idconsultaExpress").val(),
                function (data) {
            ...
            //maramos los pasos activos
            $(".vc-nc-steps li:eq(0)").addClass("active");
            $(".vc-nc-steps li:eq(0) a").addClass("btn-step-back");
            $(".vc-nc-steps li:eq(0) a").removeClass("a-nopointer");
            $(".vc-nc-steps li:eq(1)").addClass("active");
            //ir arriba
            $('html, body').animate({
            ...
            $(function () {
                ...
                //boton eliminar multiples medicos de la consulta express
                $('#btnEliminarMedicos').click(function () {
                    ...
                    if ($(".check_lock_profesional:checked").length == 1) {
                        ...
                        $("#text-profesional-modal-eliminar").html(x_translate("Eliminar los profesionales seleccionados. No se incluirán en la consulta."));
                ...
                $("#eliminar-profesional-modal-aceptar").click(function () {
                    ...
                    x_doAjaxCall(
                            'POST',
                    BASE_PATH + 'eliminar_medicos_consultaexpress.do',
                    'ids=' + ids + "&idconsultaExpress=" + $("#idconsultaExpress").val(),
                    function (data) {
                        $("#eliminar-profesional-modal").modal('hide');
                        $("#div_profesionales_red_list").spin(false);
                        if (data.result) {
                            ...
                            x_loadModule('consultaexpress', 'nuevaconsulta_step2_profesional_red_resultados', $("#f_busqueda").serialize(), "consulta-express-step-container", BASE_PATH + "paciente_p");
                        } else {
                            x_alert(data.msg);
                        }
                ...
                $(".btn-remove-filtro").click(function () {
                    ...
                    function (data) {
                        if (data.result) {
                            x_loadModule('consultaexpress', 'nuevaconsulta_step2_profesional_red_resultados', $("#f_busqueda").serialize() + "&do_reset=1", "consulta-express-step-container", BASE_PATH + "paciente_p");
                        } else {
                            x_alert(data.msg);
                ...
                //seleccionar medico de consulta express
                ...
                $("#btnSiguienteStep").click(function () {
                    ...
                    x_doAjaxCall(
                            'POST',
                    BASE_PATH + 'nuevaconsulta_step2_profesionalred.do',
