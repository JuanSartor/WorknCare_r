    ...
    <div class="container">
        ...
        <div class="user-select user-select-sonsulta-express-rsp">
            <h1 class="section-name">
                <a class="consulta-express-tittle-lnk" href="{$url}panel-paciente/consultaexpress/">
            ...
            <div class="settings consulta-express-pull-right">
                ...
                <div class="dropdown dropdown-express">
                    ...
                    <select id="combo-select-menu" class="form-control select select-primary select-block mbl ce-nc-p2-res-list-select" style="width:100%">
                        ...
                        <option value="nuevaconsulta" {if $smarty.request.submodulo=="nuevaconsulta"}selected{/if}>{"Nueva consulta"|x_translate}</option>
                        <option value="pendientes" {if $smarty.request.submodulo=="consultaexpress_pendientes"}selected{/if}>{"Pendientes"|x_translate}</option>
...
<!--	ALERTAS -  Consulta express Perfil de salud no completo	-->
<div id="modal-consultaexpress-inhabilitada" class="modal fade bs-example-modal-lg modal-perfil-completo-acreditacion" tabindex="-1" data-load="no" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    {"Complete su perfil de salud para acceder a Consulta Express"|x_translate}
                </p>
...
{*si no esta completo el perfil de salud y se intenta acceder a consulta express lanazamos el modal de error*}
        ...
        {literal}
            $(document).ready(function () {
                ...
                if (submodulo != 'bandeja_entrada') {
                    ...
                    $("#modal-consultaexpress-inhabilitada").on('hidden.bs.modal', function () {
                        window.location.href = BASE_PATH + "panel-paciente/consultaexpress/";
                    });
                }
                $("#modal-consulta-borrador").modal("hide");
                $("#modal-consultaexpress-inhabilitada").modal('show');
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#combo-select-menu").change(function () {
                if ($(this).val() != "") {
                    window.location.href = BASE_PATH + "panel-paciente/consultaexpress/" + $(this).val() + ".html";
                } else {
                    window.location.href = BASE_PATH + "panel-paciente/consultaexpress/";
                }
            });
