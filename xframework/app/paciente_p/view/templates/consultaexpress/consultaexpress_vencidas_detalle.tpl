<div id="div_consultasexpress_vencidas" class="relative cs-nc-section-holder">
    ...
    <div class="container">
        <ol class="breadcrum">
            ...
            <li><a href="{$url}panel-paciente/consultaexpress/vencidas.html">{"Vencidas"|x_translate}</a></li>
            {if $consulta_vencida}<li class="active">Nº {$consulta_vencida.numeroConsultaExpress}</li>{/if}
        </ol>
    </div>

    {if $consulta_vencida}
        <input type="hidden" id='idconsultaExpress' value="{$consulta_vencida.idconsultaExpress}"/>
        <section class="container cs-nc-p2">

            <div class="row">
                <div class="ce-ca-toobar">
                    <a href="{$url}panel-paciente/consultaexpress/vencidas.html" ><i class="icon-doctorplus-left-arrow"></i></a>
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading paciente-consulta-express-acc-header" role="tab">
                            <div class="ce-ca-toolbar" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-{$consulta_vencida.idconsultaExpress}" aria-expanded="true" aria-controls="collapse-{$consulta_vencida.idconsultaExpress}">
                        ...
                        <div id="collapse-{$consulta_vencida.idconsultaExpress}" class="panel-collapse collapse in" data-id="{$consulta_vencida.idconsultaExpress}" role="tabpanel" aria-labelledby="heading-{$consulta_vencida.idconsultaExpress}">

                            <div class="panel-body">

                                <div class="cs-ca-chat-holder ce-pc-chat-holder">
                                    <div class="row chat-row">
                                        {if $consulta_vencida.republicacion!=""}
                                            <div class="row chat-row chat-date-divider">
                                                <span class="chat-date"><small>{"Republicación Consulta Express Nº"|x_translate}{$consulta_vencida.republicacion}</small></span>
                                    ...
                                    <div class="ce-pc-chat-btn-holder">
                                        <a href="javascript:;" class="ce-pc-extender btn_extender_consulta" data-tipoconsulta="{$consulta_vencida.tipo_consulta}" data-id="{$consulta_vencida.idconsultaExpress}"><i class="icon-doctorplus-clock"></i> {"Extender plazo de respuesta"|x_translate}</a>
                                        <a href="javascript:;" data-id="{$consulta_vencida.idconsultaExpress}" class="btn_eliminar_consulta"><i class="icon-doctorplus-cruz"></i> {"Cancelar y eliminar"|x_translate}</a>
                                    </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>{"su Consulta Express pasará a estado Pendiente de confirmación"|x_translate}</p>
...
<script>
    var VENCIMIENTO_CE_RED ={$VENCIMIENTO_CE_RED};
    var VENCIMIENTO_CE_FRECUENTES ={$VENCIMIENTO_CE_FRECUENTES};
</script>
{literal}
    <script>
        var marcar_leida_consulta = function () {
            ...
            x_doAjaxCall(
                    ...
                    "idestadoConsultaExpress=5&id=" + $("#idconsultaExpress").val(),
                    function (data) {
                        ...
                        if (data.result) {
                            ...
                            if (data.leido_anteriormente == 0) {
                                ...
                                var notif_vencidas = parseInt($("#cant_consulta_vencidas").html()) - 1;
                                if (notif_vencidas > 0) {
                                    $("#cant_consulta_vencidas").html(notif_vencidas);
                                } else {
                                    $("#cant_consulta_vencidas").hide();
                                }
        ...
        $(function () {
            ...
            /*mostrar modal cancelacion consulta express*/
            ...
            /**Accion de confirar la cancelacion de consulta*/
            ...
            /**Accion de confirar la extension de plazo de consulta*/
            ...
            $(".btn_extender_consulta").click(function () {
                ...
                if (parseInt(id) > 0) {
                    ...
                    if (tipo == 1) {
                        $("#span_tiempo_extender").html(VENCIMIENTO_CE_FRECUENTES);//horas
                    } else {
                        $("#span_tiempo_extender").html(VENCIMIENTO_CE_RED);//horas
                    }
            ...
            /*Evento de desplegar / ocultar la info de la consulta*/
