        ...
        <div class="container-fluid">
            <form name="f_busqueda" id="f_busqueda" action="{$url}busqueda_profesionales_red.do" method="POST" role="form" onsubmit="return false">
                ...
                <div class="row cs-nc-p2-row-divider">
                    ...
                    <input type="text" id="as_especialidades" placeholder='{"Especialidad"|x_translate}'/>
    ...
    {literal}
        <script>
            $(function () {
                ...
                $("#especialidad_idespecialidad,#subespecialidad_medico,#idobraSocial_f").change(function () {
                    $("#idpais_f").val($("#idpais").val());
                        ...
                        function (data) {
                            if (data.result) {
                                if (data.login_prestador == 1) {
                                    ...
                                    x_loadModule('consultaexpress', 'nuevaconsulta_step2_profesional_red_resultados', "idconsultaExpress=" + $("#idconsultaExpress_f").val() + "&do_reset=1", "consulta-express-step-container", BASE_PATH + "paciente_p");
