...
//si viene desde VC o CE seleccionamos ese servicio
if ($this->request["servicio"] == "consulta-express") {
    $this->assign("servicio_busqueda", 1);
}
if ($this->request["servicio"] == "videoconsulta") {
    $this->assign("servicio_busqueda", 2);
}
//Combo Sector
$ManagerSector = $this->getManager("ManagerSector");
$this->assign("combo_sector", $ManagerSector->getCombo(1));
