                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:16px" valign="middle">
                                                    <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold;">
                                                        Votre prochaine  <a href="{$url}professionnel/video-consultation/salle-attente.html" class="rsp-lnk" target="_blank" style="color:#31A592; text-decoration:none"> Vidéo Consultation  </a> avec le patient <a href="{$url}panel-medico/perfil-salud/tablero.html?id={$paciente.idpaciente}" class="rsp-lnk" target="_blank" style="color:#31A592; text-decoration:none">{$paciente.nombre} {$paciente.apellido}</a> commence dans moins de 5 minutes .
                                                    </p>
                                ...
                                <tr>
                                    <td style="padding:16px">
                                        <p style="color:#415B70; text-align:center; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                            <a href="{$url}professionnel/video-consultation/salle-attente.html" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">Se connecter</a>
                                        </p>
