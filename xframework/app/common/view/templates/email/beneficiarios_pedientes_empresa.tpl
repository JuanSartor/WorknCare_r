                ...
                <table width="600" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td style="padding:16px">
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif"><span style="color:#F33243; font-size:18px">Bonjour {$usuario_empresa.nombre} {$usuario_empresa.apellido}</span></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:16px ">
                            <p style="color:#415B70; font-size:17px; font-family:'Helvetica', Arial, sans-serif;">
                                De nouveaux bénéficiaires se sont inscrits. Vous devez maintenant valider leur inscription pour qu'ils puissent utiliser leur WorknCare.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0 16px">
                            {foreach from=$usuarios_pendientes item=usuario}
                    ...
                    <tr>
                        <td style="padding:16px">
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                Connectez-vous à votre panel de gestion entreprise afin de valider les droits du ou des bénéficiaires.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:16px">
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                <a href="{$url}entreprises/beneficiaires.html" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">Se connecter</a>
                            </p>
