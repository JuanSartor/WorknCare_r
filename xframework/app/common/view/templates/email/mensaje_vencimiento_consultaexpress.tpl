                        ...
                        <td style="padding:0 16px 16px 16px">
                            <table width="100%" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:8px 16px" valign="top">
                                                    <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold; margin:0;padding:0;">
                                                        ...
                                                        <a href="{$url}panel-paciente/consultaexpress/vencidas-{$consulta.idconsultaExpress}.html"  class="rsp-lnk" target="_blank"  style="color:#21B796; text-decoration:none">Conseil Nº {$consulta.numeroConsultaExpress}</a> Motif: {$motivo}
                                ...
                                <tr>
                                    <td style="padding:0 16px 16px 16px">
                                        <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                            <a href="{$url}panel-paciente/consultaexpress/vencidas-{$consulta.idconsultaExpress}.html" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">Se connecter</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
