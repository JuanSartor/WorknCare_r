                    ...
                    <tr>
                        <td>
                            <table width="100%" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                                <tr>
                                    <td>
                                        {if $turno_estado!="Patient absent"}
                                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                                Le rendez-vous en  {if $turno_videoconsulta==1}Visio{else}Consultation{/if} est {$turno_estado} pour 
                                            </p>
                                        {else}
                                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                                Le rendez-vous en  {if $turno_videoconsulta==1}Visio{else}Consultation{/if} est {$turno_estado} pour 
                                        ...
                                        <td>
                                            {if $turno_videoconsulta!="1"}
                                                <p style="color:#415B70; font-size:12px; font-family:'Helvetica', Arial, sans-serif; margin-top:0;">
                                                    Nous vous conseillons de vous présenter un peu en avance pour réaliser les démarches usuelles. N'oubliez pas de vous munir de votre carte de sécurité sociale. Si vous devez modifier votre rendez-vous ou que vous devez l'annuler, vous devez vous connecter à votre compte sur WorknCare pour le faire !
                                                </p>
                                            {else}
                                                <p style="color:#415B70; font-size:12px; font-family:'Helvetica', Arial, sans-serif; margin-top:0;">
                                                    Si vous devez modifier votre rendez-vous ou que vous devez l'annuler, vous devez vous connecter à votre compte sur WorknCare pour le faire !. 
                                                </p>
                                            {/if}
                                        </td>
                                    </tr>
