                        ...
                        <div class="okm-row pcuh-pf-slide-box cotainer-slider-medicos-frecuentes">
                            ...
                            <div class="pcuh-pf-slide">
                                ...
                                <figure class="figure-new">
                                    <div class="div-circulo">{$cantMisModelos}</div>
                                    <span style="position: relative; top: -20px;">{"Mis Modelos"|x_translate}</span>
                                    <div class="okm-row text-center" style="top: -20px;">
                                        <a  href="{$url}entreprises/risquelist/0.html" class="btn btn-default btn-slider-familia">{"Ver"|x_translate}</a>

                                    </div>
                                </figure>

                                <figure class="figure-new">
                                    <div class="div-circulo">{$cantModelosGenericos}</div>
                                    <span style="position: relative; top: -20px;">{"Modelos DUERP"|x_translate}</span>
                                    <div class="okm-row text-center" style="top: -20px;">
                                        <a  href="{$url}entreprises/risquelist/1.html" class="btn btn-default btn-slider-familia">{"Ver"|x_translate}</a>
