<div class="col-md-8 col-md-offset-2 text-center">
    ...
    <ul>
        ...
        <li id="isWebsitePermissions_error" class="errorDetail" style="display:none">
            ...
            {"Debe otorgrar permisos a WorknCare para acceder a la cámara y micrófono. Por favor asegurese de tener habilitado dichos permisos."|x_translate}
        </li>
        ...
        <li id="timeout_error" class="errorDetail" style="display:none">
            {"No se pudo iniciar el test. Por favor recargue la página e intente nuevamente. Asegurese  otorgrar permisos a WorknCare para acceder a la cámara y micrófono"|x_translate}
        </li> 
    </ul>
    {*botones pop up*}
    ...
    <script>
        $(function () {
            ...
            $("#btnNuevoTestKO").click(function () {
                ...
                localStorage.setItem('reload_checkrtc_paciente', 1);
