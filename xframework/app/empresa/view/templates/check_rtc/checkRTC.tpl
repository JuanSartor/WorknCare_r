...
{/if}
<script src="{$url}xframework/app/paciente_p/view/templates/check_rtc/volume-meter.js"></script>
...
{literal}
    ...
    <script>
        var initializeMicCapture = function () {
            x_loadModule("check_rtc", "checkRTC_mic", "", "mic_container", BASE_PATH + "empresa");
        };
    </script>
    <!-- VIDEO -->
    <script>
        var initializeVideoCapture = function () {
            x_loadModule("check_rtc", "checkRTC_video", "", "video_container", BASE_PATH + "empresa");
        };
    </script>
{/literal}
