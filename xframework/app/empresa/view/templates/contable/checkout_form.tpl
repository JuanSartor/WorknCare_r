...
<div class="checkout-form" id="checkout-form" >
    ...
    <div class="plan-contratado">
        ...
        <p>
            <i class="fa fa-check"></i> {"Fecha de inicio"|x_translate}: {$fechaActual}
        </p>
        <p>
                    ...
                    <div id="setup-form-sepa" class="payment-form">
                        ...
                        <div class="okm-row ">
                            <div class="mapc-input-line">
                                ...
                                <input id="titular_cuenta_sepa" type="text"  value="{$usuario_empresa.nombre} {$usuario_empresa.apellido}" placeholder="{$usuario_empresa.nombre} {$usuario_empresa.apellido}" />
                            </div>
...
{literal}
    ...
    $(function () {
        ...
        function crear_suscripcion(customerId, paymentMethodId, priceId) {
            ...
            return x_doAjaxCall(
                    'POST',
                    BASE_PATH + "empresa.php?action=1&modulo=contable&submodulo=crear_suscripcion",
