<section class="form edit info-profesional-form">
    <div class="container">
        ...
        {if $empresa.obra_social!="1" || $empresa.plan_idplan == "21"} 
            <div class="okm-row">
            ...
            <div class="pass-sante-registro-planes">
                <div class="checkout-form" style="display: block;">
                    ...
                    <div class="okm-row text-center">
                        <button  class="btn btn-default" data-metodo='{$metodo_pago}' id="cambiar_metodo_pago" >{"cambiar metodo de pago"|x_translate}</button>
        ...
        <script>
            $(function () {
                ...
                $(document).ready(function () {
                    if ($('#cambiar_metodo_pago').data('metodo') == '') {
                        $("#cambiar_metodo_pago").trigger("click");
                    }
                });
                ...
                $("#cancelar_suscripcion").click(function (e) {
                    ...
                    jConfirm({
                        ...
                        confirm: function () {
                            ...
                            x_doAjaxCall(
                                    'POST',
                                    BASE_PATH + 'empresa.php?action=1&modulo=contable&submodulo=cancelar_suscripcion',
                                    '',
                                    function (data) {
                                        $("body").spin(false);
                                        if (data.result) {
