...
<div class="checkout-form" id="checkout-form" >
    ...
    <div class="plan-contratado">
        ...
        <p>
            <i class="fa fa-check"></i> {"Fecha de inicio"|x_translate}: {$smarty.now|date_format}
        </p>
        <p>
        ...
        <div class="tab-content ">
            ...
            <div class="tab-pane" id="sepa-panel">
                ...
                <div class="okm-row">
                    ...
                    <div class="mapc-registro-form-row center">
                        <button class="btn-default btn-process-checkout" id="btn-process-sepa" type="submit" data-secret="{$usuario_empresa.stripe_client_secret}">
...
<div class="okm-row plogin-mensaje-registro" id="subscription_ok_message" style="display:none;">
    ...
    <p class="plogin-envio-correo">
        {"Ha continuación podrá generar una invitación para compartir con sus beneficiarios"|x_translate}
    </p>
    <div class="plogin-mensaje-registro-actions">
        <a href="{$url}entreprises/" class="btn-default">{"Continuar"|x_translate}</a>
    </div>

</div>

<div class="okm-row plogin-mensaje-registro" id="subscription_manual_ok_message" style="display:none;">
    ...
    <h3>{"¡Se ha registrado su suscripcion de forma exitosa!"|x_translate}</h3>

    <p class="plogin-envio-correo">
        {"Ahora usted debe realizar la tranferencia a WorknCare. Mientras puede generar una invitación para compartir con sus beneficiarios"|x_translate}
    </p>
    <div class="plogin-mensaje-registro-actions">
...
{literal}
    ...
    $(function () {
        ...
        function activar_suscripcion(customerId, paymentMethodId) {
            ...
            return x_doAjaxCall(
                    'POST',
                    BASE_PATH + "empresa.php?action=1&modulo=contable&submodulo=activar_suscripcion_pack",
        ...
        /**
         *  Listener de procesar pago con transferencia, pongo flag contratacion_manual en 1
         */
        $("#btn-process-sepa").click(function () {
            ...
            x_doAjaxCall(
                    'POST',
                    BASE_PATH + "empresa.php?action=1&modulo=contable&submodulo=crear_suscripcion_forma_manual_empresa",
                    "idempresa=" + idEmpresa,
                    function (resultado) {
                        $("body").spin(false);
                        if (resultado.result) {
                            $("#checkout-form").hide();
                            $("#subscription_manual_ok_message").fadeIn();
                        } else {
