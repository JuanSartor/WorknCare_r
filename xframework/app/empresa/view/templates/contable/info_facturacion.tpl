...
<section class="form edit info-profesional-form form-info-facturacion" id="form_info_facturacion_container" {if $completar_info_facturacion!="1"}style="display:none;"{/if}>
    <div class="container" id="formFacturaDatos">
        ...
        <form id="frm_info_facturacion" role="form" action="{$url}empresa.php?action=1&modulo=contable&submodulo=info_facturacion_form" method="post" >
                ...
                {if $empresa.tipo_cuenta=="1"}
                    <div class="row" >
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="field-edit dp-edit">
                                <input type="text"  id="siren_input"  name="siren" {if $empresa.siren!=''} value="{$empresa.siren}" {elseif $empresa.siret!=''} value="{$empresa.siret}" {else} value="{$empresa.siren}" {/if} style="letter-spacing: 5px;" />
                            </div>
                        </div>
