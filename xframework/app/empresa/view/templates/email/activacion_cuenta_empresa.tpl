                    ...
                    <tr>
                        <td style="padding:16px 16px 0px 16px">
                            ...
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                {if $usuario.idioma_predeterminado =="fr"}  Vous venez de créer votre compte sur WorknCare, {$usuario.email} {else} You have just created your account on WorknCare, {$usuario.email} {/if}
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0 16px">
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                <a href="{$url}activation/{$hash}.html" target="_blank" title="Confirmez votre email ici" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;"> {if $usuario.idioma_predeterminado =="fr"}confirmer email{else}confirmation email{/if}</a>
                            </p>
                            {*<p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
