        ...
        <tr>
            <td bgcolor="#F7F7F7" style="padding: 24px 0; background-color: white;">
                ...
                <table width="600" align="center" border="0" valign="top" cellpadding="16" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td><img src="{$IMGS}logo_workncare_color.png" alt="WorknCare" style="border:none; margin-right: 20px;"/></td>
                            {if $empresa_entera.image!=''}
                            <td style="padding:12px 0; position: relative; right: 250px;"><img style="width: 80px; height: 80px;" src="{$empresa_entera.image.usuario}?t={$smarty.now}" alt="Socia" style="border:none"/></td>
                            {/if}
                    </tr>
                </table>
                ...
                <table width="600" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="12" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td>
                            <p style="color:#415B70; font-size:17px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold"><span style="color:#31A592; font-size:18px">Bienvenue {$usuario.nombre} {$usuario.apellido}</span></p>
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                {if $empresa.tipo_cuenta=="1"}Vos droits ont été validés par {$empresa.empresa}{else}{$empresa.nombre} {$empresa.apellido}{/if}.<br>
                                Connectez-vous pour utiliser votre Pass !
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="{$url}portailsalaries" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px; font-family:'Helvetica', Arial, sans-serif">Me connecter</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <p style="color:#31A592; font-size:15px; font-family:'Helvetica', Arial, sans-serif">
                                Pour faire une séance en visio avec l’un des professionnels inscrits ou vous faire rembourser l’une des prestations prises en charge sur simple envoi de justificatif.
                            </p>
                        </td>
                    </tr>
                    <tr>
                ...
                <table width="600" align="center" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td align="center">
                            <p style="color:#999999; font-size:12px; font-family:'Helvetica', Arial, sans-serif; text-align:center">&copy; {$smarty.now|date_format:"%Y"} WorknCare, Tous droits réservés.</p>
                        </td>
                    </tr>
                </table>
            </td>
