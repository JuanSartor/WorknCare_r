...
<div class="modal modal-flyer-capsula" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-hidden="false"  id="modal-flyer-capsula">
    <div class="modal-dialog container" role="document">
        <div class="modal-content  ">

            <input hidden id='idCapsula' name="idCapsula" value="{$capsula_lista.idcapsula}">
                ...
                <div class="form-group okm-row" id="content_to_copy">
                    ...
                    <div class="text-center">
                        ...
                        <div style="margin-left: 140px;" >
                            ...
                            <img style="width: 170px; margin-left: 100px;" class="qr-code" src="{$url}frontend_2.php?action=1&modulo=programa_salud_registro&submodulo=generar_qr_capsula&id={$smarty.request.id}" />
                    ...
                    <div class="text-center">
                        <a id="btnInputsFlyers"     class="btn btn-xs btn-default  btn-guardar dim-btns btn-agregar-pregunta "  >{"Personalizar"|x_translate}</a>
                        <a style="margin-top: 10px; display: none; margin-bottom: 10px;"  name="btngenerarFlyers" class="btn btn-xs btn-default  btn-guardar dim-btns btn-agregar-pregunta  "  id="btngenerarFlyers" href="{$url}empresa.php?action=1&modulo=capsula&submodulo=capsula_pass_flayer&id={$smarty.request.id}"    target="_blank" ><i style="margin-left: 10px;" class="fa fa-print"></i>{"Generar Flyer"|x_translate}</a>
                    </div>
...
<script>
    $(function () {
        ...
        $("#btnInputsFlyers").click(function (e) {
            ...
            x_doAjaxCall(
                    'POST',
                    BASE_PATH + "empresa.php?action=1&modulo=capsula&submodulo=cargar_inputs_flyer",
                    'idcapsula=' + idcapsula + "&titulo_flyer=" + titulo + "&subtitulo_flyer=" + subtitulo + "&complementario_flyer=" + complementario,
                    function (data) {

                        if (data.result) {
                            $("#btngenerarFlyers").css("display", "block");
