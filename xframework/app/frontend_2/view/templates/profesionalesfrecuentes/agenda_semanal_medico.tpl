        ...
        <div class="pnb-slide">
            <div class="pnb-slide-inner no-turno-disponible">
                ...
                <div class="pbn-turno-vacio pbn-turno-vacio-slider">
                    ...
                    <a href="javascript:;"  class="no-turno-select-profesional-frecuente-vc"><p>{"Video Consulta"|x_translate}</p></a>
                    <br>
                    <a href="javascript:;"  class="no-turno-select-profesional-frecuente-ce"><p>{"Consulta Express"|x_translate}</p></a>
