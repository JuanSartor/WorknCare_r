        ...
        <div class="row highlights">
            <div class="col-sm-3">
                ...
                <div class="highlight-box text-center">
                    ...
                    <a href="{$url}professionnel/creer-un-compte.html" role="button" id="cambiarCuentaGratuita" title='{"Cambiar de Cuenta Profesional a Cuenta Gratuita"|x_translate}' >{"Adquirir"|x_translate}</a>
                ...
                <div class="row special-features">
                    ...
                    <div class="col-md-4">
                        <ul>
                            ...
                            <li><span class="icon-doctorplus-video-call">{"Video Consulta"|x_translate} (1)</span></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="content-wrapper">
                                ...
                                <p>
                                    {"Sepa qué prepagas son las más utilizadas."|x_translate} <br>
...
<section class="order free-account">
    <div class="container text-center">
        <h5>{"Sin demos ni períodos de prueba."|x_translate} <br /> {"¡Una cuenta gratuita para siempre!"|x_translate}</h5>
