                ...
                <table width="600" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td style="padding:16px 16px 0px 16px">
                            <p style="color:#415B70; font-size:17px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold"><span style="color:#31A592; font-size:18px">{$usuario.dr} {$usuario.nombre} {$usuario.apellido}</span></p>
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                Vous venez de créer votre compte sur WorknCare: {$usuario.email}
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0 16px">
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                <a href="{$url}activacion/{$hash}.html" target="_blank" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;" title="Confirmez votre email ici" >confirmer email</a>
                            </p>
                            {*<p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                    ...
                    <tr>
                        <td style="padding:0 16px 0px 16px">
                            <p style="color:#F8425E; font-size:18px; font-family:'Helvetica', Arial, sans-serif">
                                Votre compte restera pour l'instant en attente de validation
                            </p>
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                Les informations renseignées seront vérifiées par WorknCare. Vous serez notifié lorsque votre compte aura été activé.
                            </p>
                        </td>
                    </tr>
                    <tr>
