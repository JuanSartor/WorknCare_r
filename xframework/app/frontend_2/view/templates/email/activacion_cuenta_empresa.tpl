                    ...
                    <tr>
                        <td style="padding:16px 16px 0px 16px">
                            ...
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                {if $usuario.idioma_predeterminado =="fr"}  Vous venez de créer votre compte sur WorknCare: {$usuario.email}{else}
                                    You have just created your account on WorknCare: {$usuario.email}
                                {/if}
                            </p>
                        </td>
                    </tr>
