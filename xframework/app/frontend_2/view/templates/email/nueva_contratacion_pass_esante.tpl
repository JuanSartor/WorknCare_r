                    ...
                    <tr>
                        <td style="padding:16px ">
                            <p style="color:#415B70; font-size:17px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold">
                                <span style="color:#31A592; font-size:18px">Un nouvel utilisateur entreprise s’est inscrit :</span>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0 16px">
                            ...
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                <span style="text-decoration:none; line-height:32px; color:#415B70; font-weight:bold">
                                    {if $usuario.tipo_cuenta=="1"}
                                        Entreprise:  {$usuario.empresa}
                                    {else}
                                        Particulier
                                    {/if}
                                </span>
                            ...
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                <span style="text-decoration:none; line-height:32px; color:#415B70; font-weight:bold">
                                    Plan contracté:  {$plan_contratado.nombre}
                                </span>
                            </p>
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                <span style="text-decoration:none; line-height:32px; color:#415B70; font-weight:bold">
                                    Date d'adhésion: {$plan_contratado.fecha_adhesion|date_format:"%d/%m/%Y"}
                                </span>
                            </p>
                        </td>
                    </tr>
