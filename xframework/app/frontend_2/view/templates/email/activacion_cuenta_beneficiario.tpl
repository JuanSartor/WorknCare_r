                ...
                <table width="600" align="center" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td style="padding:12px 0"><img src="{$IMGS}logo_workncare_color.png" alt="DoctorPlus" style="border:none"/></td>
                            {if $empresaEntera.image!=''}
                            <td style="padding:12px 0; position: relative; right: 250px;"><img style="width: 80px; height: 80px;" src="{$empresaEntera.image.usuario}?t={$smarty.now}" alt="Socia" style="border:none"/></td>
                            {/if}
                    </tr>                  
                </table>
                ...
                <table width="600" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td style="padding:16px 16px 0px 16px">
                            ...
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                ...
                                {if $usuario.idioma_predeterminado =="fr"} Vous venez de créer votre compte: {$usuario.email}{else}
                                    You have just created your account: {$usuario.email}
                                {/if}
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:0 16px">
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                                <a href="{$url}activacion/{$hash}.html" target="_blank" title="Confirmez votre email ici" style="padding: 8px 16px; color: #fff; background-color: #F95450; text-decoration: none; border-radius: 4px;">   {if $usuario.idioma_predeterminado =="fr"} confirmer email{else} confirm email{/if}</a>
                            </p>
                            {*<p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif">
                            Ou suivez ce lien pour accéder à votre compte.
                            </p>*}
                        </td>
                    </tr>
                    {*<tr>
