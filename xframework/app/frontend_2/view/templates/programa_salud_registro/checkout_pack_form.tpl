            ...
            <div class="tab-pane" id="sepa-panel">
                ...
                <div class="okm-row">
                    <div id="setup-form-sepa" class="payment-form">
                        ...
                        <div class="okm-row ">
                            <span>{"Usted debera realizar una transferencia directa hacia DoctorPlus para validar su compra"|x_translate}</span>
                        </div>   
                    </div>
                    <div class="mapc-registro-form-row center">
...
<div class="okm-row plogin-mensaje-registro" id="subscription_manual_ok_message" style="display:none;">
    ...
    <p class="plogin-envio-correo">
        {"Ahora usted debe realizar la tranferencia a DoctorPlus. Mientras puede generar una invitación para compartir con sus beneficiarios"|x_translate}
    </p>
    <div class="plogin-mensaje-registro-actions">
        <a href="{$url}programmes-bienetre/checkout_ok.html?id={$plan_contratado.hash}" class="btn-default">{"Continuar"|x_translate}</a>
    </div>
    ...
    <script>
        $(function () {
            ...
            $("#btn-process-sepa").click(function () {
                ...
                x_doAjaxCall(
                        'POST',
                        BASE_PATH + "frontend_2.php?action=1&modulo=programa_salud_registro&submodulo=crear_suscripcion_forma_manual",
                        "idempresa=" + idEmpresa,
                        function (resultado) {
                            $("body").spin(false);
                            if (resultado.result) {
