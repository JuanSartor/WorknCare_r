...
<div class="col-md-4 col-sm-6 col-xs-12">
    <div class="hidden-xs">
        <button class="card"><img class="img-responsive" src="{$IMGS}amex_logo.png" title="American Express"></button>
        <button class="card"><img class="img-responsive" src="{$IMGS}visa_logo.png" title="Visa"></button>
        <button class="card"><img class="img-responsive" src="{$IMGS}mastercard_logo.png" title="Mastercard"></button>
    </div>
