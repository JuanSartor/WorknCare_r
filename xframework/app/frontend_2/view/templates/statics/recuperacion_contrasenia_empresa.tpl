...
<div class="plogin-header">
    ...
    <h1>{"Restablecer contraseña"|x_translate}</h1>
</div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        {if $resultado}
                            <form name="usr-registro-cuenta"  id="frmRegistro" role="form" action="{$url}{$controller}.php?action=1&modulo=login&submodulo=recuperacion_contrasenia_empresa" method="post" onsubmit="return false;">
