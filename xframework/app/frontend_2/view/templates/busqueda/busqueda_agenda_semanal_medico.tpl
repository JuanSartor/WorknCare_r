            ...
            <div class="pnb-slide-inner no-turno-disponible">
                <div class="pbn-turno-vacio pbn-turno-vacio-slider">
                    ...
                    {if $consultorio.is_virtual == 1 }
                        <a class="a_reservar_turno_vc" data-idturno="{$agenda.idturno}" href="javascript:;">
                            <p>
                    ...
                    {else}
                        <a class="a_reservar_turno" data-idturno="{$agenda.idturno}" href="javascript:;">
                            <p>
                                {$agenda.fecha|getDiaSemanaXFecha} {$agenda.fecha|date_format:"%d/%m"} - {$agenda.horarioInicio|date_format:"%H:%M"} {"hs"|x_translate}
                                <i class="fa fa-check-circle"></i>
                            </p>
        ...
        <div class="pnb-slide">
            <div class="pnb-slide-inner no-turno-disponible">
                <div class="pbn-turno-vacio pbn-turno-vacio-slider">
                    ...
                    <a href="javascript:;"  data-id="{$consultorio.medico_idmedico}"  class="no-turno-select-profesional-frecuente-vc"><p>{"Video Consulta"|x_translate}</p></a>
                    <a href="javascript:;" data-id="{$consultorio.medico_idmedico}" class="no-turno-select-profesional-frecuente-ce"><p>{"Consulta Express"|x_translate}</p></a>
                </div>
            </div>
        </div>
    {/if}
            ...
            <div class="pnb-slide-inner">
                        ...
                        {foreach from=$agenda[1].turnos item=turno}
                            <li>
                                {if $consultorio.is_virtual == 1 }
                                    ...
                                    {else}
                                        <a class="a_reservar_turno_vc" data-idturno="{$turno.idturno}" href="javascript:;">{$turno.horario}</a>
                                    {/if}
                                {else}
                                    <a class="a_reservar_turno" data-idturno="{$turno.idturno}" href="javascript:;">{$turno.horario}</a>
                                {/if}
                            </li>
                        {/foreach}
                    </ul>
                ...
                <div class="pnb-slide-col {if $agenda[2].vacaciones=='1'} pnb-vacaciones  {/if}">
                    ...
                    {if $agenda[2].turnos|@count > 5}
                        <a href="javascript:;" class="pbn-mas-trigger">Más...</a>
                    {/if}
...
<script>
    ...
    $("#pbn-turnos-holder-{$idconsultorio_contenedor}").data("fecha", "{$dia_agenda}");


</script>
{* fix para el ancho de la tabla de horarios*}

{*
{if $agenda.hay_siguiente ==1}
<script>
$("#pnb-slide-{$consultorio.idconsultorio}").closest(".pbn-turnos-holder").css("min-width", "200px");
</script>
{else}
<script>
$("#pnb-slide-{$consultorio.idconsultorio}").closest(".pbn-turnos-holder").css("min-width", "600px");
</script>
{/if}
*}