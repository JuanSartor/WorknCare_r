...
$("#list").jqGrid({
    ...
    colModel: [
        ...
        {name: 'motivoConsultaExpress', index: 'motivoConsultaExpress', width: 150, sortable: false}
    ...
    gridComplete: function() {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','motivo_consultaexpress_form','id=" + id + "','Main',this)\">Editar</a>";
