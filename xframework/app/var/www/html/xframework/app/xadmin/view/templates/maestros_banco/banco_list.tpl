<div id="colRight">	
    ...
    <div class="block">
        ...
        <div class="title_bar"><span class="text">	BANCOS &raquo; </span>
        ...
        <div class="contenido">
            ...
            <div class="xForm">
                <form action="{$controller}.php?action=1&modulo=maestros_banco&submodulo=banco_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >
                    ...
                    <div class="form_container">
                        ...
                        <ul>
                            ...
                            <li class="right">
                                <label>Pais </label> 
                                <select name='pais_idpais' id='pais_idpais'>
