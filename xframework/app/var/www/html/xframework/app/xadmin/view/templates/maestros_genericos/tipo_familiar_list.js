...
$("#submodulo").val("tipo_familiar_list");
x_runJS();
...
$("#list").jqGrid({
    ...
    colModel: [
        ...
        {name: 'tipoFamiliar', index: 'tipoFamiliar', width: 150, sortable: false}
    ...
    gridComplete: function () {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','tipo_familiar_form','id=" + id + "','Main',this)\">Editar</a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function () {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja el registro?',
        submodulo: 'deletemultiple_tipo_familiar'
    });
...
$("#btnNew").click(function () {
    x_goTo('maestros_genericos', 'tipo_familiar_form', '', 'Main', this);
});
