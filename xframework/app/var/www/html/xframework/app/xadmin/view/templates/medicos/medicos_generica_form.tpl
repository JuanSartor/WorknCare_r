{if $record}
    <div id="colRight">
        ...
        <div class="block">
            ...
            <div class="title_bar"><div class="text">M&Eacute;DICO &raquo;  EDITAR </div>   
                    ...
                    <form action="{$controller}.php?action=1&modulo=medicos&submodulo=medicos_generica_form"  method="post"  name="f_record" id="f_record" >
                        ...
                        <ul>
                            ...
                            <li class="wide">
                                ...
                                <input type='hidden' name="especialidad_medico" id="especialidad_medico" value='{$record.mis_especialidades.0.idespecialidad}'>
                                <span>{$record.mis_especialidades.0.especialidad}</span>                 
                            </li>
                            <li class="left">
                        ...
                        <div id="div_imagenes_tarjetas">
                            {foreach from=$imagenes_tarjetas item=tarjeta}


                                <a title="{$tarjeta.nombre}" target="_blank" href="{$tarjeta.path}">
                                    {if $tarjeta.nombre=="cps"}
                                        <strong>{"Foto de tarjeta CPS"|x_translate}</strong>
                                    {else}
                                        <strong>{"Foto de su DNI"|x_translate}</strong>
                                    {/if}
                                    <br>
                                    {if $tarjeta.ext==".pdf"}
                                        <img src="{$url}xframework/app/themes/dp02/imgs/ico_pdf.png" width="50px" height="50px;" />
                                    {else}
                                        <img src="{$tarjeta.path}" width="50px" height="50px;" />
                                    {/if}
                            ...
                            {foreachelse}
                                <div class="wide">
                                    ...
                                    <strong>{"No hay archivos adjuntos"|x_translate} </strong>
