...
$("#list").jqGrid({
    ...
    datatype: "json",
    colNames: ['', 'Sector','tarifa'],
    colModel: [
        {name: 'act', index: 'act', width: 50, hidden: false, sortable: false},
        {name: 'sector', index: 'sector', width: 150, sortable: false},
        {name: 'tarifa', index: 'tarifa', width: 150, sortable: false}
    ...
    gridComplete: function() {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','sector_form','id=" + id + "','Main',this)\">Editar</a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function() {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja el Sector?',
        submodulo: 'deletemultiple_sector'
    });
...
$("#btnNew").click(function() {
    x_goTo('maestros_genericos', 'sector_form', '', 'Main', this);
});
*/