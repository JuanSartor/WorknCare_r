...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background-color:#F7F7F7; font-family:Arial, Helvetica, sans-serif; font-size:1em;">
        ...
        <div style="padding:20px 30px; max-width:700px;">
            ...
            <a href="http://www.doctorplus.eu" title="DoctorPlus"><img src="{$url}mails/mail_logo.png" width="373" height="80"  border="0" /></a>
            <div style="background-color:#FFF; padding:30px 20px; margin-top:20px;" style="font-size:12px;">
                ...
                <p style="font-size:10px;">Esta dirección de correo electrónico no admite respuestas. Para obtener más información, visita el Centro de ayuda de DoctorPlus. 	
                    Si {$usuario.email} no es tu cuenta de DoctorPlus, envianos un email a <a href="mailto:unsubscribe@doctorplus.eu">unsubscribe@doctorplus.eu</a> para desconectar tu dirección de correo electrónico de esta cuenta. 
                </p>

            </div>

            <div style="text-align:center; margin:20px 0px;">
                <a href=""  title="Políticas de Privacidad"><img src="{$url}mails/mail_link_politicas.png" width="266"  border="0" height="62" alt="Políticas de Privacidad" title="Políticas de Privacidad" longdesc="http://www.doctorplus.com/politicas-de-privacidad.html" /></a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a href="" alt="Soporte Técnico"><img src="{$url}mails/mail_link_soporte.png" width="266" height="62" border="0"  alt="Soporte Técnico" title="Soporte Técnico" longdesc="http://www.doctorplus.com/soporte.html" /></a>
            </div>

            <div style="text-align:center; margin:20px 0px;">
                <img src="{$url}mails/mail_logo_footer.png" width="313" height="58"  border="0" title="DoctorPlus 2019 - Tous droits réservés" />
            </div>        
        </div>
