<div id="colRight">
    ...
    <div class="block">
        ...
        <div class="title_bar">
            <span class="text">NOTIFICACIONES MÉDICO &raquo; {if $record} EDITAR {else} NUEVA{/if} </span>
        ...
        <div class="contenido">
            ...
            <div class="xForm">
                <form action="{$controller}.php?action=1&modulo=notificaciones&submodulo=notificaciones_medico_form" target="_blank"  method="post"  name="f_record" id="f_record" >
                    <input type="hidden" name="idnotificacionSistema" id="idnotificacionSistema" value="{$record.idnotificacionSistema}" />
                    <input type="hidden" name="ids" id="ids" value="" />
                    <input type="hidden" name="is_notificacion_medico" id="is_notificacion_medico" value="1" />
            ...
            <div class="xForm">
                <form action="{$controller}.php?action=1&modulo=notificaciones&submodulo=notificaciones_medico_form_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >
