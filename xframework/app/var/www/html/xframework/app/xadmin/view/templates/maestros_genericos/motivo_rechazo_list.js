...
$("#submodulo").val("motivo_rechazo_list");
x_runJS();
...
$("#list").jqGrid({
    ...
    colModel: [
        ...
        {name: 'motivoRechazo', index: 'motivoRechazo', width: 150, sortable: false}
        
    ],
    
    rowNum: 50,
    pager: '#pager',
    sortname: 'motivoRechazo',
    viewrecords: true,
    sortorder: "asc",
    ...
    gridComplete: function() {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('maestros_genericos','motivo_rechazo_form','id=" + id + "','Main',this)\">Editar</a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function() {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja el Motivo de Rechazo?',
        submodulo: 'deletemultiple_motivo_rechazo'
    });
...
$("#btnNew").click(function() {
    x_goTo('maestros_genericos', 'motivo_rechazo_form', '', 'Main', this);
});
