                            ...
                            <div id="div_imagenes_tarjetas">
                                {foreach from=$imagenes_tarjetas item=tarjeta}
                                    ...
                                    <a title="{$tarjeta.nombre}" target="_blank" href="{$tarjeta.path}">
                                        {if $tarjeta.nombre=="vitale"}
                                            <strong>{"Tarjeta Vitale"|x_translate}</strong>
                                        {else if $tarjeta.nombre=="eID"}
                                            <strong>{"Tarjeta eID"|x_translate}</strong>
                                        {else if $tarjeta.nombre=="cns"}
                                            <strong>{"Tarjeta CNS"|x_translate}</strong>
                                        {else if $tarjeta.nombre=="pasaporte"}
                                            <strong>{"Pasaporte"|x_translate}</strong>
                                        {/if}
                                        <br>
                                        {if $tarjeta.ext==".pdf"}
