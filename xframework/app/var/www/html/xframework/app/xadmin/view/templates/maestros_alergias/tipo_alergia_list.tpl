<div id="colRight">
    ...
    <div class="block">
        ...
        <div class="title_bar">
            <span class="text">ALERGIAS &raquo; SUB TIPO ALERGIA &raquo; </span>
        ...
        <div class="contenido">
            ...
            <div class="xForm">
                <form action="{$controller}.php?action=1&modulo=maestros_alergias&submodulo=tipo_alergia_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >
                    <input type="hidden" name="tipoAlergia_idtipoAlergia" id="tipoAlergia_idtipoAlergia" value="{$tipoAlergia.idtipoAlergia}" />

                    <div class="form_container">
                        <div class="title">
                            Consulta de Tipo de Alergia
                        </div>
