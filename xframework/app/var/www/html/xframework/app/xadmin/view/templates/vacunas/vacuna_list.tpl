<div id="colRight">	
    ...
    <div class="block">
        ...
        <div class="title_bar"><span class="text">VACUNA &raquo; </span>
        ...
        <div class="contenido">
            <div class="xForm">
                <form action="{$controller}.php?action=1&modulo=vacunas&submodulo=vacuna_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >
