        ...
        <tr>
            <td bgcolor="#F7F7F7" style="padding: 24px 0">
                ...
                <table width="600" align="center" bgcolor="#ffffff" border="0" valign="top" cellpadding="12" cellspacing="0" style="border-collapse:collapse">
                    <tr>
                        <td>
                            <p style="color:#415B70; font-size:16px; font-family:'Helvetica', Arial, sans-serif; font-weight:bold">Felicitations  <span style="color:#31A592; font-size:18px">{$usuario.dr}  {$usuario.nombre} {$usuario.apellido}</span></p>
