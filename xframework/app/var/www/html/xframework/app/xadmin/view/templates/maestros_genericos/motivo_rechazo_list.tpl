<div id="colRight">	
    ...
    <div class="block">
        ...
        <div class="contenido">
            ...
            <div class="xForm">
                <form action="{$controller}.php?action=1&modulo=maestros_genericos&submodulo=motivo_rechazo_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >
                    ...
                    <div class="form_container">
                        ...
                        <ul>
                            ...
                            <li class="left">
                                <label>Nombre </label> 
                                {x_form_input  id="motivoRechazo" descriptor="none" isRequired="false" maxChars=45 class="" value=$paginate.request.motivoRechazo} 
                            </li>   
