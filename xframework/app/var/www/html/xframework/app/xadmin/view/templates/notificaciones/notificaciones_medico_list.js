...
$("#submodulo").val("notificaciones_medico_list");
x_runJS();
...
$("#list").jqGrid({
    ...
    colModel: [
        ...
        {name: 'titulo', index: 'titulo', width: 50, align:'center', sortable: true},
        {name: 'fechaCreacion_format', index: 'fechaCreacion', width: 40, sortable: true},
    ...
    viewrecords: true,
    sortorder: "asc",
    caption: "Notificaciones de los medicos",
    ...
    gridComplete: function() {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            be = "<a href=\"javascript:;\" title=\"Editar\" onclick=\"x_goTo('notificaciones','notificaciones_medico_form','id=" + id + "','Main',this)\"><img src=\"xframework/app/themes/admin/imgs/action_ico_edit.png\" /></a>";
...
$('<a href="javascript:;" title="Eliminar">Eliminar</a>').appendTo("#pager_left").click(function() {
    ...
    x_deleteMultiple({ids: $("#list").jqGrid('getGridParam', 'selarrrow'),
        callback: reload,
        pregunta: 'Desea dar de baja las notificiones de médico?',
        submodulo: 'deletemultiple_notificaciones_medico'
    });
...
$("#btnNew").click(function() {
    x_goTo('notificaciones', 'notificaciones_medico_form', '', 'Main', this);
});
