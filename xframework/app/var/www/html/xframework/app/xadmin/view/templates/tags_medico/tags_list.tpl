<div id="colRight">	
    ...
    <div class="block">
        ...
        <div class="title_bar"><span class="text">	TAGS &raquo; </span>
        ...
        <div class="contenido">
            ...
            <div class="xForm">
                <form action="{$controller}.php?action=1&modulo=tags_medico&submodulo=tags_list" target="_blank"  method="post"  name="f_busqueda" id="f_busqueda" >
                    <div class="form_container">
                        ...
                        <ul>
                            <li class="wide">
                                ...
                                {x_form_input  id="nombreTag" descriptor="none" isRequired="false" maxChars=45 class="" record=$paginate.request}
                            </li>         
