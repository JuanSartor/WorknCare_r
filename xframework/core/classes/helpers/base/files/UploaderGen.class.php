 ...
 *
 */
class UploaderGen { // class ManagerUpload
    // variables
     ...
     *
     */
    function UploaderGen($fieldName, $maxSize = 9000000, $descriptionType = NULL) {
    ...
    function getMimeTypeByDescription($description) {
        ...
        switch ($description) {
            ...
            case 'flash':
                ...
                break;
            case 'multi_img':
                $result = "image/pjpeg,image/jpeg,image/gif,image/png";
                break;
            case 'img_pdf':
                $result = "image/pjpeg,image/jpeg,image/gif,image/png,application/pdf";
                break;
            case '*':
                $result = "*";
                break;
