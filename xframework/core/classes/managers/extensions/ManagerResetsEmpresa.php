<?php
   ...
   * 	Manager de RESETS
   *    Resets de contraseña para los usuarios  -> Empresa
   * 
   */
  class ManagerResetsEmpresa extends Manager {
      ...
      function __construct($db) {
          ...
          parent::__construct($db, "resetsempresa", "idresetsempresa");
      }
      ...
      public function validateResets($request) {
          ...
          $query->setSelect("r.$this->id, r.usuario_empresa_idusuario_empresa,(r.validez > NOW()) as valido,r.hash");
