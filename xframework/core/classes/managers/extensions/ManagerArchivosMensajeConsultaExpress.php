 ...
 * @author lucas
 */
class ManagerArchivosMensajeConsultaExpress extends ManagerMedia {
    ...
    function __construct($db) {
        ...
        parent::__construct($db, "archivosmensajeconsultaexpress", "idarchivosMensajeConsultaExpress");

        $this->setImgContainer("mensajes_ce");

        $this->setImgContainerMultiple("images_mensajes_ce");
        $this->addImgType("jpg");
        $this->addImgType("png");
    ...
    /**
     * Método que procesa el upload múltiple de los archivos correspondientes a las CE
     * @param type $request
     * @return boolean
     */
    public function processAllFiles($request) {
        ...
        $request["mensajeConsultaExpress_idmensajeConsultaExpress"] = $request["idmensajeConsultaExpress"];
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            if (isset($_SESSION[$hash][$i])) {
                ...
                $dir = path_root("xframework/files/temp/images_mensajes_ce/{$hash}/");
                $path = path_root("xframework/files/temp/images_mensajes_ce/{$hash}/{$i}.{$ext}");
     ...
     * @return boolean
     */
    public function cloneArchivoMensaje($id_archivo_mensaje_old, $idmensajeConsultaExpress) {
        ...
        if (is_file($path_to_clone)) {
            ...
            $insert_archivo_mensaje["mensajeConsultaExpress_idmensajeConsultaExpress"] = $idmensajeConsultaExpress;
