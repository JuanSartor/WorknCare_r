<?php
   ...
   *
   */
  class ManagerResets extends Manager {
      ...
      function __construct($db) {
          ...
          parent::__construct($db, "resets", "idreset");
      }
      ...
      public function validateResets($request) {
          ...
          $query->setSelect("r.$this->id, r.usuarios_idusuarios,(r.validez > NOW()) as valido,r.hash");
          $query->setFrom(" resets r");
