...
/**
 * 	Manager del glucemia
 *
 * 	@author Xinergia
 * 	@version 1.0
 * 	@package managers\extensions
 */
class ManagerGlucemia extends Manager {
    ...
    function __construct($db) {
        ...
        // Constructor
        parent::__construct($db, "glucemia", "idglucemia");
    }
    ...
    public function insert($record) {
        ...
        foreach ($array_insert as $key => $value) {
            ...
            if (!is_numeric($record[$value])) {
                $this->setMsg([ "msg" => "Error. El campo es numérico", "result" => false]);
                return false;
            }
        }
        ...
        if ($rdo) {
            ...
            if ($ultimo) {
                ...
                if (!$update) {
                    $this->setMsg([ "msg" => "Error. No se pudo registrar la información referida al glucemia", "result" => false]);
                    return false;
                }
            }
            ...
            $this->setMsg([ "msg" => "Error. No se pudo registrar la información de glucemia", "result" => false]);
            return false;
        }
    }

    /**
     * Método que obtiene del glucemia el último valor para poder ser modificado en el FrontEnd
