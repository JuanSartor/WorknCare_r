 ...
 *
 */
class ManagerProgramaSaludGrupoEmpresa extends ManagerMedia {
    ...
    function __construct($db) {
        ...
        parent::__construct($db, "programa_salud_grupo_empresa", "idprograma_salud_grupo_empresa");
        $this->setImgContainer("programa_salud_grupo_empresa");
        $this->addImgType("png");
    ...
    public function getListadoJSON($request, $idpaginate = NULL) {
        ...
        // Filtro
        if ($request["programa_salud_grupo_empresa"] != "") {

            $rdo = cleanQuery($request["programa_salud_grupo_empresa"]);
    ...
    public function getListadoGrupoProgramas() {
        ...
        foreach ($listado as $key => $grupo) {
            ...
            $listado[$key]["listado_programas"] = $ManagerProgramaSaludGrupoAsociacion->getProgramasAsociados($grupo["idprograma_salud_grupo_empresa"]);
            $listado[$key]["imagenesgrupoempresa"] = $this->getImagenes($grupo["idprograma_salud_grupo_empresa"]);
            $listado[$key]["cantprogramas"] = count($listado[$key]["listado_programas"]);
        }
        return $listado;
    }
